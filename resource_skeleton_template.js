(function () {
    ...
    dynamicLoading.js('https://static.fliphtml5.com/resourceFiles/html5_templates/js/deString.js?1751608961');
    dynamicLoading.js('https://static.fliphtml5.com/resourceFiles/html5_templates/js/jquery-3.7.1.min.js')
    dynamicLoading.css('https://static.fliphtml5.com/resourceFiles/html5_templates/template/Popular/style/style.css?1751608961')
    dynamicLoading.js('https://static.fliphtml5.com/resourceFiles/html5_templates/template/Popular/javascript/book.min.js?1751608961')
    ...
    window.pageEditorUrl = 'https://static.fliphtml5.com/resourceFiles/html5_templates/js/pageItems.min.js?1751608961';
    ...
    // window.pageSliderUrl = 'https://static.fliphtml5.com/resourceFiles/html5_templates/js/LoadSlider.js?1751608961';
    // if (window.sliderJS &&
    //     window.sliderJS.length > 0) {
    //     dynamicLoading.js(pageSliderUrl)
    // }
    ...
    dynamicLoading.js('https://static.fliphtml5.com/resourceFiles/html5_templates/template/Popular/javascript/main.min.js?1751608961')
    ...
    var interval = window.setInterval(function () {
        ...
        dynamicLoading.js('https://static.fliphtml5.com/resourceFiles/js/encryption/encryption.min.js?1751608961')
        if(loadPlugin) {
            dynamicLoading.js('https://static.fliphtml5.com/resourceFiles/js/plugin.js?1751608961')
        }
        dynamicLoading.js('https://static.fliphtml5.com/resourceFiles/js/statistic.js?1751608961')
        dynamicLoading.js('https://static.fliphtml5.com/resourceFiles/js/writeLog.js?1751608961')
        dynamicLoading.js('https://static.fliphtml5.com/resourceFiles/js/visitinfo.js?1751608961')
