...
p){function t(w){return function(u){B[w]=u;v--;0==v&&n(B)}}var B=[],v=0;do B.push(void 0),v++,d(l.value).callWhenSettled_(t(B.length-1),p),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
var windowWidth=20,windowHeight,originTotalPageCount,totalPageCount,isTouch=!1,bookContainer,tmpContainer,slideBook,singleSlideBook,catalogBook,singleCatalogBook,flipBook,singlePageBook,cardBook,flipShotButton,toolBar,printBody,helpBody,aboutBody,sharePanel,annotationPannel,videoGallery,photoGallery,languagePanel,frmSearch,frmShare,frmTableOfContent,bookmark,thumbnail,googleID,noteCookie,textRemark,signature,annotationShapes,QRcode,QRbutton,moreBar,pageIndexTextField,resizeBookAfterFlip=!1,flipAudio,
...
(function(b,c,d,e){function f(m,q,r){return setTimeout(n(m,r),q)}function g(m,q,r){return Array.isArray(m)?(h(m,r[q],r),!0):!1}function h(m,q,r){var z;if(m)if(m.forEach)m.forEach(q,r);else if(m.length!==e)for(z=0;z<m.length;)q.call(r,m[z],z,m),z++;else for(z in m)m.hasOwnProperty(z)&&q.call(r,m[z],z,m)}function k(m,q,r){var z="DEPRECATED METHOD: "+q+"\n"+r+" AT \n";return function(){var C=Error("get-stack-trace");C=C&&C.stack?C.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,
"{anonymous}()@"):"Unknown Stack Trace";var D=b.console&&(b.console.warn||b.console.log);D&&D.call(b.console,z,C);return m.apply(this,arguments)}}function l(m,q,r){q=q.prototype;var z=m.prototype=Object.create(q);z.constructor=m;z._super=q;r&&S(z,r)}function n(m,q){return function(){return m.apply(q,arguments)}}function p(m,q){return"function"==typeof m?m.apply(q?q[0]||e:e,q):m}function t(m,q,r){h(w(q),function(z){"undefined"!=typeof b.addEventListener?m.addEventListener(z,r,!1):m.attachEvent(z,r)})}
function B(m,q,r){h(w(q),function(z){"undefined"!=typeof b.removeEventListener?m.removeEventListener(z,r,!1):m.detachEvent(z,r,!1)})}function v(m,q){for(;m;){if(m==q)return!0;m=m.parentNode}return!1}function w(m){return m.trim().split(/\s+/g)}function u(m,q,r){if(m.indexOf&&!r)return m.indexOf(q);for(var z=0;z<m.length;){if(r&&m[z][r]==q||!r&&m[z]===q)return z;z++}return-1}function x(m){return Array.prototype.slice.call(m,0)}function y(m,q,r){for(var z=[],C=[],D=0;D<m.length;){var E=q?m[D][q]:m[D];
0>u(C,E)&&z.push(m[D]);C[D]=E;D++}r&&(z=q?z.sort(function(J,P){return J[q]>P[q]}):z.sort());return z}function A(m,q){if(q&&q[0]){for(var r,z=q[0].toUpperCase()+q.slice(1),C=0;C<oa.length;){r=(r=oa[C])?r+z:q;if(r in m)return r;C++}return e}}function G(m){m=m.ownerDocument||m;return m.defaultView||m.parentWindow||b}function F(m,q){var r=this;this.manager=m;this.callback=q;this.element=m.element;this.target=m.options.inputTarget;this.domHandler=function(z){p(m.options.enable,[m])&&r.handler(z)};this.init()}
function O(m,q,r){var z=r.pointers.length,C=r.changedPointers.length;var D=q&1&&0===z-C;r.isFirst=!!D;r.isFinal=!!(q&12&&0===z-C);D&&(m.session={});r.eventType=q;q=m.session;z=r.pointers;C=z.length;q.firstInput||(q.firstInput=L(r));1<C&&!q.firstMultiple?q.firstMultiple=L(r):1===C&&(q.firstMultiple=!1);D=q.firstInput;var E=(C=q.firstMultiple)?C.center:D.center;var J=r.center=H(z);r.timeStamp=fa();r.deltaTime=r.timeStamp-D.timeStamp;r.angle=M(E,J);r.distance=K(E,J);D=r.center;E=q.offsetDelta||{};J=
q.prevDelta||{};var P=q.prevInput||{};if(1===r.eventType||4===P.eventType)J=q.prevDelta={x:P.deltaX||0,y:P.deltaY||0},E=q.offsetDelta={x:D.x,y:D.y};r.deltaX=J.x+(D.x-E.x);r.deltaY=J.y+(D.y-E.y);r.offsetDirection=I(r.deltaX,r.deltaY);E=r.deltaTime;D=r.deltaX/E||0;E=r.deltaY/E||0;r.overallVelocityX=D;r.overallVelocityY=E;r.overallVelocity=V(D)>V(E)?D:E;C?(D=C.pointers,D=K(z[0],z[1],Y)/K(D[0],D[1],Y)):D=1;r.scale=D;C?(C=C.pointers,z=M(z[1],z[0],Y)+M(C[1],C[0],Y)):z=0;r.rotation=z;r.maxPointers=q.prevInput?
r.pointers.length>q.prevInput.maxPointers?r.pointers.length:q.prevInput.maxPointers:r.pointers.length;E=q.lastInterval||r;z=r.timeStamp-E.timeStamp;8!=r.eventType&&(25<z||E.velocity===e)?(D=r.deltaX-E.deltaX,E=r.deltaY-E.deltaY,J=D/z||0,P=E/z||0,z=J,C=P,J=V(J)>V(P)?J:P,D=I(D,E),q.lastInterval=r):(J=E.velocity,z=E.velocityX,C=E.velocityY,D=E.direction);r.velocity=J;r.velocityX=z;r.velocityY=C;r.direction=D;q=m.element;v(r.srcEvent.target,q)&&(q=r.srcEvent.target);r.target=q;m.emit("hammer.input",r);
m.recognize(r);m.session.prevInput=r}function L(m){for(var q=[],r=0;r<m.pointers.length;)q[r]={clientX:X(m.pointers[r].clientX),clientY:X(m.pointers[r].clientY)},r++;return{timeStamp:fa(),pointers:q,center:H(q),deltaX:m.deltaX,deltaY:m.deltaY}}function H(m){var q=m.length;if(1===q)return{x:X(m[0].clientX),y:X(m[0].clientY)};for(var r=0,z=0,C=0;C<q;)r+=m[C].clientX,z+=m[C].clientY,C++;return{x:X(r/q),y:X(z/q)}}function I(m,q){return m===q?1:V(m)>=V(q)?0>m?2:4:0>q?8:16}function K(m,q,r){r||(r=pa);var z=
q[r[0]]-m[r[0]];m=q[r[1]]-m[r[1]];return Math.sqrt(z*z+m*m)}function M(m,q,r){r||(r=pa);return 180*Math.atan2(q[r[1]]-m[r[1]],q[r[0]]-m[r[0]])/Math.PI}function W(){this.evEl=za;this.evWin=Aa;this.pressed=!1;F.apply(this,arguments)}function Z(){this.evEl=qa;this.evWin=ra;F.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function aa(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;F.apply(this,arguments)}function T(){this.evTarget=
Ba;this.targetIds={};F.apply(this,arguments)}function U(m,q){var r=x(m.touches),z=this.targetIds;if(q&3&&1===r.length)return z[r[0].identifier]=!0,[r,r];m=x(m.changedTouches);var C=[],D=this.target;var E=r.filter(function(J){return v(J.target,D)});if(1===q)for(r=0;r<E.length;)z[E[r].identifier]=!0,r++;for(r=0;r<m.length;)z[m[r].identifier]&&C.push(m[r]),q&12&&delete z[m[r].identifier],r++;if(C.length)return[y(E.concat(C),"identifier",!0),C]}function ha(){F.apply(this,arguments);var m=n(this.handler,
this);this.touch=new T(this.manager,m);this.mouse=new W(this.manager,m);this.primaryTouch=null;this.lastTouches=[]}function sa(m){m=m.changedPointers[0];if(m.identifier===this.primaryTouch){var q={x:m.clientX,y:m.clientY};this.lastTouches.push(q);var r=this.lastTouches;setTimeout(function(){var z=r.indexOf(q);-1<z&&r.splice(z,1)},2500)}}function ia(m,q){this.manager=m;this.set(q)}function Ca(m){if(-1<m.indexOf("none"))return"none";var q=-1<m.indexOf("pan-x"),r=-1<m.indexOf("pan-y");return q&&r?"none":
...
m.concat(q.getTouchAction()))});return Ca(m.join(" "))},preventDefaults:function(m){var q=m.srcEvent,r=m.offsetDirection;if(this.manager.session.prevented)q.preventDefault();else{var z=this.actions,C=-1<z.indexOf("none")&&!ea.none,D=-1<z.indexOf("pan-y")&&!ea["pan-y"];z=-1<z.indexOf("pan-x")&&!ea["pan-x"];if(C){var E=2>m.distance,J=250>m.deltaTime;if(1===m.pointers.length&&E&&J)return}if(!z||!D)if(C||D&&r&6||z&&r&24)return this.preventSrc(q)}},preventSrc:function(m){this.manager.session.prevented=
...
m)&&q&m.offsetDirection&&m.distance>this.options.threshold&&m.maxPointers==this.options.pointers&&V(r)>this.options.velocity&&m.eventType&4},emit:function(m){var q=ua(m.offsetDirection);q&&this.manager.emit(this.options.event+q,m);this.manager.emit(this.options.event,m)}});l(da,Q,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return["manipulation"]},process:function(m){var q=this.options,r=m.pointers.length===q.pointers,z=m.distance<
q.threshold,C=m.deltaTime<q.time;this.reset();if(m.eventType&1&&0===this.count)return this.failTimeout();if(z&&C&&r){if(4!=m.eventType)return this.failTimeout();r=this.pTime?m.timeStamp-this.pTime<q.interval:!0;z=!this.pCenter||K(this.pCenter,m.center)<q.posThreshold;this.pTime=m.timeStamp;this.pCenter=m.center;this.count=z&&r?this.count+1:1;this._input=m;if(0===this.count%q.taps)return this.hasRequireFailures()?(this._timer=f(function(){this.state=8;this.tryEmit()},q.interval,this),2):8}return 32},
...
z=q.curRecognizer;if(!z||z&&z.state&8)z=q.curRecognizer=null;for(var C=0;C<r.length;){var D=r[C];2===q.stopped||z&&D!=z&&!D.canRecognizeWith(z)?D.reset():D.recognize(m);!z&&D.state&14&&(z=q.curRecognizer=D);C++}}},get:function(m){if(m instanceof Q)return m;for(var q=this.recognizers,r=0;r<q.length;r++)if(q[r].options.event==m)return q[r];return null},add:function(m){if(g(m,"add",this))return this;var q=this.get(m.options.event);q&&this.remove(q);this.recognizers.push(m);m.manager=this;this.touchAction.update();
return m},remove:function(m){if(g(m,"remove",this))return this;if(m=this.get(m)){var q=this.recognizers;m=u(q,m);-1!==m&&(q.splice(m,1),this.touchAction.update())}return this},on:function(m,q){if(m!==e&&q!==e){var r=this.handlers;h(w(m),function(z){r[z]=r[z]||[];r[z].push(q)});return this}},off:function(m,q){if(m!==e){var r=this.handlers;h(w(m),function(z){q?r[z]&&r[z].splice(u(r[z],q),1):delete r[z]});return this}},emit:function(m,q){this.options.domEvents&&Ea(m,q);var r=this.handlers[m]&&this.handlers[m].slice();
...
!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,n=0,p=0,t=0;f.animateInterval=function(B,v){k=$.easing.swing(null,n,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,n,f.parameters.height,f.parameters.height*(g-1),20);p=$.easing.swing(null,n,f.parameters.left,
f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);t=$.easing.swing(null,n,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:p+"px",top:t+"px"});for(var w=0;w<f.side.pageArray.length;w++)if(f.side.pageArray[w])f.side.pageArray[w].onResize(k/2,l);n++;if(20<=n||B>=v){f.animateInterval.stop();f.parameters.left=f.parameters.naturalLeft+50*(f.parameters.naturalWidth-
...
(f.y+=d.parameters.height*e/4),BookInfo.isLeftPage(g[0],!0)||bookConfig.FlipDirection||(f.x-=d.parameters.width*e/4),BookInfo.isLeftPage(g[0],!0)&&!bookConfig.FlipDirection&&(f.x+=d.parameters.width*e/4))}return f}d.parameters.origin||(d.parameters.origin={x:0,y:0});g=f.x;f=f.y;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left-d.parameters.origin.x*(e-1)*h/100;var n=d.parameters.top-d.parameters.origin.y*(e-1)*k/100;var p=e*h,t=e*k,B=0,v=0,w=0,u=0;toolBar&&(B=0===toolBar.getTopHeight()?
0:toolBar.getTopHeight()+10,v=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,w=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,u=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(p>windowWidth){var x=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-u;l=-l-h*e*d.parameters.zoomArea.left/100+w}else x=-l-h*e*d.parameters.zoomArea.left/100+w,l=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-u;t>windowHeight?(h=windowHeight-t-n+k*e*d.parameters.zoomArea.bottom/100-
v,d=-n-k*e*d.parameters.zoomArea.top/100+B):(h=-n-k*e*d.parameters.zoomArea.top/100+B,d=windowHeight-t-n+k*e*d.parameters.zoomArea.bottom/100-v);g=Number.between(g,x,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,g);d.parameters.toScale=e}};this.mathTran=function(d,e,f){if(!e||
...
this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(p,t){n(p,t,"Sine")}).animation(this,300)}.bind(this),n=function(p,t,B){if(p<t){B=k(null,p,this.parameters.tran.x,e.x-this.parameters.tran.x,t);var v=k(null,p,this.parameters.tran.y,e.y-this.parameters.tran.y,t);p=k(null,p,this.parameters.scale,d-this.parameters.scale,t);t={};t.scale=p;t.tran={x:B,
y:v};B=transformCSS(t);this.css(B)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(p){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=this.tranLimit(d,
...
f=f[0];void 0==c&&(c=!1);var n=getHost(f.src),p=getHost();if(n&&p!==n){if(g=f.src.replace(n,p),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(u){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var t=h.getImageData(0,0,k,l),B=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&t){var v=Color(b).split();k=0;for(var w=t.data.length;k<w;k+=4)0<B.data[k+3]&&(t.data[k]!=v.r&&(B.data[k]=t.data[k]/255*v.r),t.data[k+1]!=v.g&&(B.data[k+1]=
t.data[k+1]/255*v.g),t.data[k+2]!=v.b&&(B.data[k+2]=t.data[k+2]/255*v.b));h.putImageData(B,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(u){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(x){}})}}}}};
...
$.fn.speed=function(b){function c(w){w=void 0==w.originalEvent.touches?[w]:w.originalEvent.touches;if(1<w.length)return t=!0;f=h=w[0].pageX;g=k=w[0].pageY;l=new Date;-1!=p&&window.clearInterval(p);p=window.setInterval(function(){f=h;g=k;l=new Date},300)}function d(w){if(-1==p||1==t)return!0;w=void 0==w.originalEvent.touches?[w]:w.originalEvent.touches;h=w[0].pageX;k=w[0].pageY}function e(w){if(-1==p)return!0;w=void 0!=w.originalEvent.touches==0?[w]:w.originalEvent.touches;if(1==t)return t=1<w.length,
!0;n=new Date;w=(n-l)/20;var u=h-f,x=k-g;0==w?v=B=0:(B=u/w,v=x/w);void 0!=b&&b(B,v);window.clearInterval(p);p=-1}var f,g,h,k,l,n,p=-1,t=!1,B=0,v=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(w){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(w){}};
(function(b){var c="object"==typeof exports&&exports,d="object"==typeof module&&module&&module.exports==c&&module,e="object"==typeof global&&global;if(e.global===e||e.window===e)b=e;var f=function(k){this.message=k};f.prototype=Error();f.prototype.name="InvalidCharacterError";var g={encode:function(k){k=String(k);if(/[^\0-\xFF]/.test(k))throw new f("The string to be encoded contains characters outside of the Latin1 range.");for(var l=k.length%3,n="",p=-1,t,B,v,w=k.length-l;++p<w;)t=k.charCodeAt(p)<<
16,B=k.charCodeAt(++p)<<8,v=k.charCodeAt(++p),t=t+B+v,n+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(t>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(t>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(t>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(t&63);2==l?(t=k.charCodeAt(p)<<8,B=k.charCodeAt(++p),t+=B,n+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(t>>
10)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(t>>4&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(t<<2&63)+"="):1==l&&(t=k.charCodeAt(p),n+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(t>>2)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(t<<4&63)+"==");return n},decode:function(k){k=String(k);for(var l=k.length,n=0,p,t,B="",v=-1;++v<l;)t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(k.charAt(v)),
p=n%4?64*p+t:t,n++%4&&(B+=String.fromCharCode(255&p>>(-2*n&6)));return B},version:"0.1.0"};if("function"==typeof define&&"object"==typeof define.amd&&define.amd)define(function(){return g});else if(c&&!c.nodeType)if(d)d.exports=g;else for(var h in g)g.hasOwnProperty(h)&&(c[h]=g[h]);else b.base64=g})(this);function parsHexToNormalString(b){for(var c="";2<=b.length;)c+=String.fromCharCode(parseInt(b.substring(0,2),16)),b=b.substring(2,b.length);return c}
...
(bookType=BookType.single_book,changeShowBook(bookType),c=flipBook.currentPageIndex,b=!0);bookType==BookType.documentView_book&&windowWidth<windowHeight&&"auto"==bookConfig.showDoublePage&&(bookType=BookType.singleDocumentView_book,changeShowBook(bookType),c=singleDocumentViewBook.currentPageIndex,b=!0);bookType==BookType.card_book&&(changeShowBook(bookType),c=cardBook.currentPageIndex,b=!0);resizeFlipBook();resizeCatalogBook();resizeSlideBook();resizeDocumentViewBook();resizeCardBook();b&&(gotoPageFun(c,
!1,"change book type"),global.thumbnail&&thumbnail.clearHighLight(),global.thumbnail&&thumbnail.setHighLight(c))}}
...
b=!0);bookType==BookType.documentView_book&&windowWidth>=windowHeight&&"auto"==bookConfig.showDoublePage&&(bookType=BookType.singleDocumentView_book,changeShowBook(bookType),c=singleDocumentViewBook.currentPageIndex,b=!0);bookType==BookType.card_book&&(changeShowBook(bookType),c=cardBook.currentPageIndex,b=!0);resizeFlipBook();resizeCatalogBook();resizeSlideBook();resizeDocumentViewBook();resizeCardBook();b&&(gotoPageFun(c,!1,"change book type"),global.thumbnail&&thumbnail.clearHighLight(),global.thumbnail&&
thumbnail.setHighLight(c))}function getStaticAdVisible(){return isPhone()||isPad()||!global.staticAd||!global.staticAd.haveAd||global.staticAd.adPosition?!1:!0}
...
"");tmpBookConfig.productVersion=getConfigValue("productVersion","");tmpBookConfig.PDFBASE_VERSION_MAC=getConfigValue("PDFBASE_VERSION_MAC","");tmpBookConfig.PDFBASE_VERSION=getConfigValue("PDFBASE_VERSION","");tmpBookConfig.isCachePages=getConfigValue("isCachePages",!1);tmpBookConfig.displayNumberOfShares=getConfigValue("displayNumberOfShares",!1);tmpBookConfig.additionalNumberOfShare=getConfigValue("additionalNumberOfShare",0);tmpBookConfig.flipSoundURL=getConfigValue("flipSoundURL","");tmpBookConfig.isTableOfContentPagesVisible=
getConfigValue("isTableOfContentPagesVisible",!1);tmpBookConfig.isArticlePhoneMoreButtonVisible=getConfigValue("isArticlePhoneMoreButtonVisible",!1);tmpBookConfig.alwaysShowBottomFullscreenPrompt=getConfigValue("alwaysShowBottomFullscreenPrompt",!1);tmpBookConfig.bottomFullscreenPromptDisplayDuration=getConfigValue("bottomFullscreenPromptDisplayDuration",3);tmpBookConfig.isChatBotButtonVisible=getConfigValue("isChatBotButtonVisible",!1);tmpBookConfig.articleTitlePosition=getConfigValue("articleTitlePosition",
"center").toLocaleLowerCase();tmpBookConfig.phoneFlipShortcutButtonSize=getConfigValue("phoneFlipShortcutButtonSize","large").toLocaleLowerCase();tmpBookConfig.socialSharingList=getConfigValue("socialSharingList",void 0);tmpBookConfig.socialShareType=getConfigValue("socialShareType","0");tmpBookConfig.isRestorePageFrameVisible=getConfigValue("isRestorePageFrameVisible",!0);tmpBookConfig.alwaysShowBookInstructionOnStart=getConfigValue("alwaysShowBookInstructionOnStart","0");tmpBookConfig.showBookInstructionCountOnStart=
getConfigValue("showBookInstructionCountOnStart",3);tmpBookConfig.toolBarBrandInfoVisible=getConfigValue("toolBarBrandInfoVisible",void 0);void 0!==tmpBookConfig.toolBarBrandInfoVisible&&(tmpBookConfig.toolBarBrandInfoVisible=parseBool(tmpBookConfig.toolBarBrandInfoVisible));tmpBookConfig.toolBarBrandInfoUrl=getConfigValue("toolBarBrandInfoUrl","");tmpBookConfig.loadingBrandInfoVisible=getConfigValue("loadingBrandInfoVisible",!1);tmpBookConfig.loadingBrandInfoUrl=getConfigValue("loadingBrandInfoUrl",
"");tmpBookConfig.relatedBrandInfoVisible=getConfigValue("relatedBrandInfoVisible",!1);tmpBookConfig.relatedBrandInfoUrl=getConfigValue("relatedBrandInfoUrl","");tmpBookConfig.relatedCardVisible=getConfigValue("relatedCardVisible",!1);tmpBookConfig.relatedCardUrl=getConfigValue("relatedCardUrl","");tmpBookConfig.bookBaseURL=getConfigValue("bookBaseURL","");tmpBookConfig.bookResourceBaseURL=getConfigValue("bookResourceBaseURL","");!tmpBookConfig.bookResourceBaseURL&&window.htmlConfig&&window.htmlConfig.loadingConfig&&
window.htmlConfig.loadingConfig.bookResourceBaseURL&&(tmpBookConfig.bookResourceBaseURL=window.htmlConfig.loadingConfig.bookResourceBaseURL);!tmpBookConfig.bookResourceBaseURL&&window.bookResourceBaseURL&&(tmpBookConfig.bookResourceBaseURL=window.bookResourceBaseURL);try{tmpBookConfig.bookResourceBaseURL||"Chinese"==UserGroups||"article"!=window.templeteName&&"article2"!=window.templeteName&&"article3"!=window.templeteName||(tmpBookConfig.bookResourceBaseURL=window.location.origin+window.location.pathname.remove("mobile/index.html"),
...
getConfigValue("AutoPlayButtonVisible",!1);tmpBookConfig.autoPlayAutoStart=getConfigValue("autoPlayAutoStart",!1);tmpBookConfig.autoPlayDuration=getConfigValue("autoPlayDuration",3);tmpBookConfig.autoPlayLoopCount=getConfigValue("autoPlayLoopCount",1);tmpBookConfig.minZoomWidth=getConfigValue("minZoomWidth",0);tmpBookConfig.minZoomHeight=getConfigValue("minZoomHeight",0);tmpBookConfig.maxZoomScale=getConfigValue("maxZoomScale",4);tmpBookConfig.maxZoomHeight=getConfigValue("maxZoomHeight",0);tmpBookConfig.defaultZoomScale=
getConfigValue("defaultZoomScale",2);tmpBookConfig.defaultZoomHeight=getConfigValue("defaultZoomHeight",0);tmpBookConfig.middleZoomWidth=getConfigValue("middleZoomWidth",0);isNaN(tmpBookConfig.middleZoomWidth)&&(tmpBookConfig.middleZoomWidth=0);tmpBookConfig.mouseWheelFlip=getConfigValue("mouseWheelFlip",!0);tmpBookConfig.DownloadButtonVisible=getConfigValue("DownloadButtonVisible",!0);tmpBookConfig.DownloadURL=getConfigValue("DownloadURL","");fixDownloadURLValue();tmpBookConfig.bgBeginColor=getConfigValue("bgBeginColor",
...
typeof e?parseBool(d):"string"==typeof e&&"#"==e[0]?Color(d).toString():d}(b,c);"string"==typeof b&&(b=b.replaceAll("\\/","/",!0),b=b.replaceAll('\\"','"'),b.startsWith("[")&&b.endsWith("]")&&(b=eval(b)));return b},getConfigValue=function(b,c){b=getValueFromConfig(b,c);"string"==typeof b&&0<=b.indexOf("files")&&(b=fixURLValue(b));return b};
...
(function(){function b(l){l+="=";for(var n=decodeURIComponent(document.cookie).split(";"),p=0;p<n.length;p++){var t=n[p].trim();if(0===t.indexOf(l))return JSON.parse(t.substring(l.length))}return null}function c(l,n){var p=new Date;p.setTime(p.getTime()+31536E8);document.cookie=l+"="+n+";expires="+p.toUTCString()+(";domain="+("Chinese"==UserGroups?".yunzhan365.com":".fliphtml5.com")+";path=/")}function d(){for(var l={},n=window.location.search.substring(1).split("&"),p=0;p<n.length;p++){var t=n[p].split("="),
B=decodeURIComponent(t[0]);t=t[1]?decodeURIComponent(t[1]):null;l[B]=t}return l}function e(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(l){var n=16*Math.random()|0;return("x"===l?n:n&3|8).toString(16)})}try{var f=b("first_visit_channel_source");if(!f||!f.uuid){var g=e(),h={channel:"",referer:document.referrer,page:window.location.href,time:(new Date).getTime(),uuid:g},k=d();k.source?h.channel=k.source:k.i?h.channel="invite_code":k.utm_code?h.channel=k.utm_code:1===Object.keys(k).length&&
null===Object.values(k)[0]&&(h.channel=Object.keys(k)[0]);c("first_visit_channel_source",JSON.stringify(h))}}catch(l){}})();
var VERSION_NAME="6.4.9",BUILD_DATE="2025063001",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},BrowserType=
...
A.rect.endY&&(y.rect.endY=A.rect.endY);y.rect.width=y.rect.endX-y.rect.x;y.rect.height=y.rect.endY-y.rect.y}});return y}function p(u){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,u,t):t(u)}function t(u){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,u,B):B(u)}function B(u){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var x=bookConfig.periodsConfigPath;x=x.replace("%periodicalId%",window.book_visit.periodicalId);c(x,u,v)}else v(u)}
...
var globalImages=[],canvasData=[],canvasLoad=function(b,c,d,e,f,g){var h=$("<canvas class='test'></canvas>"),k=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){e&&e(c,c,h,b);l.jumpToEnd()})};(function(){var l=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){$.ajax({url:c,type:"GET",dataType:"json",success:function(p){canvasData[b]="string"==typeof p?JSON.parse(p):p;globalImages[b]=[];(function(){if(0==canvasData[b].resources.length)k();else for(var t=0,
B=0;B<canvasData[b].resources.length;B++)if(1!=canvasData[b].resources[B].type)t++,t>=canvasData[b].resources.length&&k();else{var v=new Image;v.src=getResource(b,B);globalImages[b][B]=v;v.onload=function(){t++;t>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});n.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,n,p,t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(v){bookConfig.largePageWidth/bookConfig.largePageHeight>v[0].naturalWidth/v[0].naturalHeight?v.css({width:"auto",height:"100%"}):v.css({width:"100%",height:"auto"})};for(n=0;n<c.length;n++)p=c[n],p=p.removeStartFrom("?"),t=$("<img style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),t.attr("src",p),k.append(t),t[0].onload=function(v){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},t[0].onerror=function(v){h++;h==c.length&&
e&&e(c,c,k,b)};B.jumpToEnd()})},noneLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){h=$("<div style='width:100%;height:100%;background:"+bookConfig.pageBackgroundColor+";'></div>");e&&e(c,c,h,b);return k.return()})},jsLoad=function(b,c,d,e,f,g){var h,k,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){h=function(t,B){return!t||passwardType()&&bookConfig.excludeFrontPages&&B>parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()?!1:
!0};if(!h(c,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),function(){pageResourceLoad(b,d,e)},function(){}),p.return();if(k=global[decodeDatabasePrefix(d)+b]&&"string"==typeof global[decodeDatabasePrefix(d)+b])return l=dataBase64Str(b,d),n=$("<img src='"+l+"'/>"),n[0].onload=function(){e&&e(l,c,this,b)},p.return();loadJavascript(c,function(t){var B=dataBase64Str(b,d,t);$("<img src='"+B+"'/>")[0].onload=function(){e&&e(B,c,this,b)}},function(){});
return p.return()})},zipLoad=function(b,c,d,e,f,g){var h=this,k,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(!window.printLoadStack)return p.return();k=f?f:BookInfo.getBook().pageWidth;l=g?g:BookInfo.getBook().pageHeight;n=new PdfLoadingTask(b,d,k,l,function(t){var B=t.toDataURL("image/png"),v=$("<img src='"+B+"'/>");v[0].onload=function(){e&&e(B,B,v,b)}}.bind(h));window.printLoadStack.push(n);return p.return()})},svgLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){bookConfig.useTheAliCloudChart&&
...
JsLoad=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g){var h=this,k,l,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return h.index=b,h.type=c,h.pageWidth=e,h.pageHeight=f,h.isMirrorSide=g,t.yield(getPageDir(b,c,originTotalPageCount),2);k=t.yieldResult;h.imageURL=k;if(!h.fillImageOrNot(k,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),
function(){this.create(b,c,d)}.bind(h),function(){}),t.return();if(l=global[decodeDatabasePrefix(c)+b]&&"string"==typeof global[decodeDatabasePrefix(c)+b])return n=dataBase64Str(b,c),h.$image=$("<img src='"+n+"'/>"),h.$image[0].onload=function(){d&&d(n,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(h),t.return();p=h;loadJavascript(k,function(B){var v=dataBase64Str(b,c,B);p.$image=$("<img src='"+
v+"'/>");p.$image[0].onload=function(){d&&d(v,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(p)},function(){});t.jumpToEnd()})},fillImageOrNot:function(b,c){return!b||"string"!=typeof b||passwardType()&&bookConfig.excludeFrontPages&&c>parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()?!1:!0},zoomIn:function(){(isPhone()||isPad())&&bookConfig.highDefinitionConversion&&this.highDefinition()},
...
k=this.loadAllImage;(function(){var l=this,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return p.yield(getPageDir(b,c,originTotalPageCount),2);n=p.yieldResult;$.ajax({url:n,type:"get",async:!1,success:function(t){canvasData[b]=configForPages.pages[b-1].data;globalImages[b]=[];k(b,h)}.bind(l),error:function(){}});p.jumpToEnd()})})()},loadAllImage:function(b,c){for(var d=0,e=0;e<canvasData[b].resources.length;e++)if(1!=canvasData[b].resources[e].type)d++,d>=canvasData[b].resources.length&&
c();else{var f=new Image;f.src=getResource(b,e);globalImages[b][e]=f;f.onload=function(){d++;d>=canvasData[b].resources.length&&c()}}},zoomIn:function(){},zoomOut:function(){},onResize:function(){},renderCnvas:function(b,c,d,e,f,g,h){if(bookConfig.usePdfJs&&d){this.renderInterval&&(window.clearInterval(this.renderInterval),this.renderInterval=void 0);this.render&&(this.render.taskPool.stop(),this.render=void 0);var k=canvasData[e],l=k.page,n=f,p=g,t=f/g,B=l.width/l.height;.01<=t-B&&!PageInfo.pageIsStrech(this.pageIndex)&&
(n=l.width*g/l.height);-.01>=t-B&&!PageInfo.pageIsStrech(this.pageIndex)&&(p=f*l.height/l.width);if(!window.devicePixelRatio||isPC())window.devicePixelRatio=1;f=n*devicePixelRatio/l.width;d.attr("width",n*devicePixelRatio);d.attr("height",p*devicePixelRatio);d.css("height",p+"px");d.css("width",n+"px");d.css({position:"absolute",top:0,bottom:0,left:0,right:0,margin:"auto"});g=d[0].getContext("2d");g.save();g.imageSmoothingEnabled=!0;l.background&&(g.fillStyle=int2color(l.background),g.fillRect(0,
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),n=Math.ceil(k/2),p=b.getContext("2d"),t=p.getImageData(0,0,f,g),B=p.createImageData(c,d);t=t.data;for(var v=B.data,w=0;w<d;w++)for(var u=0;u<c;u++){for(var x=4*(u+w*c),y,A=0,G=0,F=0,O=0,L=0,H=0,I=(w+.5)*k,K=Math.ceil((w+1)*k),M=Math.floor(w*k);M<K;M++){var W=Math.abs(I-(M+.5))/n,Z=(u+.5)*h;W*=W;for(var aa=Math.ceil((u+1)*h),T=Math.floor(u*h);T<aa;T++)if(y=Math.abs(Z-(T+.5))/l,y=
Math.sqrt(W+y*y),!(1<=y)){y=2*y*y*y-3*y*y+1;var U=4*(T+M*f);H+=y*t[U+3];G+=y;255>t[U+3]&&(y=y*t[U+3]/250);F+=y*t[U];O+=y*t[U+1];L+=y*t[U+2];A+=y}}v[x]=F/A;v[x+1]=O/A;v[x+2]=L/A;v[x+3]=H/G}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(B,0,0)}
...
e.onload=function(){g=this.result+g;var l=new FileReader;l.onload=function(){g+=this.result;var n=f.slice(0,4E3),p=new FileReader;p.onload=function(){var t=new Uint8Array(this.result);for(i=0;i<this.result.byteLength;++i)t[i]=255-t[i];t=new Blob([new Blob([t.buffer]),f.slice(4E3,f.size)],{type:"application/pdf"});t=window.URL.createObjectURL(t);c({url:t,password:g})};p.readAsArrayBuffer(n)};l.readAsText(k)};e.readAsText(h)}};d.send()}.bind(this))}
...
this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),ImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var n=this,p,t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){n.index=b;n.type=d;n.i=l;n.callback=e;n.errorCallback=f;n.pageWidth=g;n.pageHeight=h;n.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(p=p.removeStartFrom("?"));n.imageURL=
...
function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(n);bookConfig.textSharpening&&(t="-webkit-optimize-contrast",_agent_.browser.firefox&&(t="-moz-crisp-edges"),_agent_.browser.opera&&(t="-o-crisp-edges"),n.$image.css({"image-rendering":t,"-ms-interpolation-mode":"nearest-neighbor"}));B.jumpToEnd()})},zoomIn:function(b){bookConfig.useTheAliCloudChart&&isPC()?this.switchLargeImage(b):(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&
...
25,"Sine");p++}.interval(this,l/25)}.bind(this):function(){k=function(p,t){n(p,t,"Sine")}.animation(this,l)}.bind(this);var n=function(p,t,B){if(!b)return!1;var v=b.pageWidth,w=b.pageHeight,u=$.easing["easeInOut"+B],x=$.easing["easeOut"+B];B=x(null,p,g,b.toPoint.x-g,t);x=x(null,p,h,b.toPoint.y-h,t);b.dragMoveToFlip||(B=u(null,p,g,b.toPoint.x-g,t),x=bookConfig.FlipDirection?f*Math.sqrt(w*w-B*B):w-f*Math.sqrt(v*v-B*B));p<t?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,
...
this.mapCursor=$("<div class='map_cursor'></div>");this.map.append(this.imageLeft);this.map.append(this.imageRight);this.map.append(this.mapCursor);bookContainer.append(this.map)},show:function(){this.visible=!0;this.refreshArea();this.map.show()},hide:function(){this.visible=!1;this.map.hide()},onResize:function(){bookConfig.largePageWidth/bookConfig.largePageHeight<this.maxWidth/this.maxHeight?(this.pageWidth=this.maxWidth,this.pageHeight=bookConfig.largePageHeight*this.maxWidth/bookConfig.largePageWidth):
(this.pageHeight=this.maxHeight,this.pageWidth=bookConfig.largePageWidth*this.maxHeight/bookConfig.largePageHeight);bookConfig.FlipDirection?(this.height=this.book.doublePage?2*(this.pageHeight+1):this.pageHeight,this.width=this.pageWidth+2):(this.height=this.pageHeight+2,this.width=this.book.doublePage?2*(this.pageWidth+1):this.pageWidth);var b=20+bookConfig.rightMargin,c=templateArea.getTopHeight()+10+bookConfig.topMargin;this.map.css({left:"auto",right:b+"px",top:c,width:this.width+"px",height:this.height+
"px"});$(".map_img").css({width:this.pageWidth+"px",height:this.pageHeight+"px"});this.doublePage=this.book.doublePage},fillContent:function(b){this.visible&&(b=BookInfo.getCurrentPages(),this.doublePage=1<b.length,bookConfig.FlipDirection?(this.doublePage?(this.fillImage(this.imageLeft,b[0]),this.fillImage(this.imageRight,b[1]),this.imageLeft.show(),this.imageRight.show(),this.imageLeft.css({"border-bottom":"none"})):(this.fillImage(this.imageLeft,b[0]),this.imageLeft.show(),this.imageRight.hide(),
this.imageLeft.css({"border-bottom":"1px solid gray"})),this.height=this.pageHeight,this.doublePage&&(this.height=2*(this.pageHeight+1)),this.map.css({height:this.height+"px"})):(this.doublePage?(this.fillImage(this.imageLeft,b[0]),this.fillImage(this.imageRight,b[1]),this.imageLeft.show(),this.imageRight.show(),this.imageLeft.css({"border-right":"none"})):(this.fillImage(this.imageLeft,b[0]),this.imageLeft.show(),this.imageRight.hide(),this.imageLeft.css({"border-right":"1px solid gray"})),this.width=
this.pageWidth,this.doublePage&&(this.width=2*(this.pageWidth+1)),this.map.css({width:this.width+"px"})),$(".map_img").css({width:this.pageWidth+"px",height:this.pageHeight+"px"}))},fillImage:function(b,c){b&&pageResourceLoad(c,"thumb",function(d){b.attr("src",d)})},refreshArea:function(){if(this.book.showPage){var b=this.book.showPage,c=b.width(),d=b.height();b=getTransform(b[0]);var e=this.getBookPosition();if(1==this.book.doublePage&&0==this.doublePage)if(bookConfig.FlipDirection){d/=2;var f=BookInfo.getBook().getCurrentPageIndex();
BookInfo.isLeftPage(f,!0)||(e.top+=d)}else c/=2,f=BookInfo.getBook().getCurrentPageIndex(),BookInfo.isLeftPage(f,!0)||(e.left+=c);f=-(e.left+b.x);var g=-(e.top+b.y);b=(f+windowWidth)/c;e=(g+windowHeight)/d;c=Math.max(0,f/c);d=Math.max(0,g/d);b=Math.min(1,b);e=Math.min(1,e);f=this.width;this.mapCursor.css({left:c*f,top:d*this.height,width:(b-c)*f,height:(e-d)*this.height})}},getBookPosition:function(){var b=this.book.showPage.css("left");b=parseInt(b.replace("px",""));var c=this.book.showPage.css("top");
c=parseInt(c.replace("px",""));return{left:b,top:c}},initEvent:function(){var b=new Hammer.Manager(this.mapCursor[0]);b.add(new Hammer.Pan);b.on("panstart panmove panend pancancel",this.onPan.bind(this))},onPan:function(b){if(b&&b.pointers&&1==b.pointers.length){var c=this.book.showPage.width()/this.width,d=this.book.showPage.height()/this.height;c=this.book.showPage.panForMove(this.book.showPage,-b.deltaX*c,-b.deltaY*d,!1);this.refreshArea();this.mapCursor.css({"background-color":"RGBA(245,225,135,0.8)",
cursor:"move"});if("panend"==b.type||"pancancel"==b.type)this.mapCursor.css({"background-color":"RGBA(250,240,185,0.5)",cursor:"default"}),this.book.showPage.setZoomParameters(this.book.showPage,c),this.book.showPage.restrictInBoundary(this.book.showPage,this.refreshArea.bind(this))}}}),FlipShotBar=Class({create:function(b){this.flipShotObj=$("<div id='flipShotBar' class='flipShotBar'></div>");this.flipShotObj.css({"z-index":2*(bookConfig.totalPageCount+5)+1});this.isLeft=b;this.visible=!0;this.width=
50;this.height=0;this.init();this.initEvents();this.flipShotObj.append(this.firstDiv);this.flipShotObj.append(this.prevDiv)},init:function(){this.firstDiv=$("<div class='flipbutton upbutton'></div>");this.prevDiv=$("<div class='flipbutton downbutton'></div>");this.isLeft?(this.firstDiv.addClass("left"),this.prevDiv.addClass("left"),this.prevImageUrl=uiBaseURL+"slide_leftButton.png",this.firstImageUrl=uiBaseURL+"catalog_firstButton.png"):(this.firstDiv.addClass("right"),this.prevDiv.addClass("right"),
this.prevImageUrl=uiBaseURL+"slide_rightButton.png",this.firstImageUrl=uiBaseURL+"catalog_lastButton.png");this.prevDiv.append("<img src='"+this.prevImageUrl+"'/>");this.firstDiv.append("<img src='"+this.firstImageUrl+"'/>")},onResize:function(b,c){var d=Math.min(50,.7*c/8),e=Math.min(.7*c,310);this.width=d;this.height=e;this.flipShotObj.css({width:d,height:e});this.setPosition(b,c)},setPosition:function(b,c){this.flipShotObj.css({left:this.isLeft?1-this.width:"100%",top:(c-this.height)/2})},setScale:function(b){this.width*=
b;this.height*=b;this.flipShotObj.css({width:this.width,height:this.height})},setVisible:function(b){this.flipShotObj.css({display:b?"block":"none"});this.visible=b},getContainer:function(){return this.flipShotObj},initEvents:function(){this.isLeft?(this.prevDiv.bind(_event._end,function(b){rightToLeft?nextPageFun("flip shot bar"):previousPageFun("flip shot bar")}),this.firstDiv.bind(_event._end,function(b){rightToLeft?lastPageFun("flip shot bar"):firstPageFun("flip shot bar")})):(this.prevDiv.bind(_event._end,
function(b){rightToLeft?previousPageFun("flip shot bar"):nextPageFun("flip shot bar")}),this.firstDiv.bind(_event._end,function(b){rightToLeft?firstPageFun("flip shot bar"):lastPageFun("flip shot bar")}));this.prevDiv.on("mousedown mouseup touchstart",function(b){b.stopPropagation()});this.firstDiv.on("mousedown mouseup touchstart",function(b){b.stopPropagation()})},setVisibleByIndex:function(b){this.isLeft?(1<b&&(rightToLeft||this.setVisible(!0)),b<originTotalPageCount-1&&rightToLeft&&this.setVisible(!0),
3>=b&&(bookConfig.RightToLeft||1>=b&&this.setVisible(!1)),b>=originTotalPageCount-2&&bookConfig.RightToLeft&&b>=originTotalPageCount-1&&this.setVisible(!1)):(1<b&&rightToLeft&&this.setVisible(!0),b<originTotalPageCount-1&&(rightToLeft||this.setVisible(!0)),3>=b&&bookConfig.RightToLeft&&1>=b&&this.setVisible(!1),b>=originTotalPageCount-2&&(bookConfig.RightToLeft||b>=originTotalPageCount-1&&this.setVisible(!1)))},refresh:function(){}}),setCurrentIndexTextField=function(b){b=getShownPageNumberInfo(b);
$("#guidPageIndex").html("<b>"+b+"</b>");$("#currentPageIndexTextField")&&$("#currentPageIndexTextField")[0]&&!$("#currentPageIndexTextField")[0].onFocus&&$("#currentPageIndexTextField").val(b);if(isMacOSChrome()){var c,d;null==(c=global)||null==(d=c.toolBar)||d.resetPageNumberSize(b.length)}c=$(".currentPageIndexTextField");for(d=0;d<c.length;d++)c[d]&&!c[d].onFocus&&$(c[d]).val(b)},getShownPageNumberInfo=function(b){BookInfo.isDoublePage();b=BookInfo.getCurrentPages();for(var c=originTotalPageCount,
d="",e=0;e<b.length;e++){var f=getShownPageNumber(b[e]);0!=e&&d!=f&&(d+="-");d!=f&&(d+=f)}0==b.length&&(d=getShownPageNumber(1));bookConfig.totalPagesCaption&&(c=bookConfig.totalPagesCaption);return rightToLeft?c+"/"+d:d+"/"+c},getShownPageArray=function(){var b=bookConfig.pageNumberCaption+"",c=originTotalPageCount;";"==b.substr(b.length-1,1)&&(b=b.substr(0,b.length-1));b=b.split(";");for(var d=[],e=0;e<b.length;e++)if(""!=b[e]&&void 0!=b[e]){var f=b[e].split(":");if(f[0])if(f[1]||(f[1]=""),-1<f[1].indexOf("+")){var g=
f[0];g.indexOf("-");g=g.split("-");var h=g[0];g=g[1];h=parseInt(h);var k=g?parseInt(g):c;f=getPageNumberFormat(f[1]);for(var l=h;l<=k;l++){var n=(l-h)*f.addition+f.startPage;g="";0==f.type&&(g=n+"");1==f.type&&(g=parseRoman(n));2==f.type&&(g=parseRoman(n).toLowerCase());d[l]=String.format(f.page,g)}}else if(!isNaN(f[0]))h=parseInt(f[0]),d[h]=void 0==f[1]?"":f[1];else if(-1<f[0].indexOf("-"))for(g=f[0],g.indexOf("-"),g=g.split("-"),h=g[0],g=g[1],h=parseInt(h),k=g?parseInt(g):c,l=h;l<=k;l++)d[l]=void 0==
f[1]?"":f[1]}return d};function getPageNumberFormat(b){var c={page:"%s",startPage:1,type:0,addition:1};if(-1<b.indexOf("{")){var d=b.indexOf("{"),e=b.indexOf("}")+1;d=b.substring(d,e);c.page=b.replace(d,"%s");-1<d.indexOf("N+")&&(c.type=0);-1<d.indexOf("R+")&&(c.type=1);-1<d.indexOf("r+")&&(c.type=2);d=d.subBetween("+","}");c.startPage=""==d?1:parseInt(d)}else d=b.split("+")[0],b=b.split("+")[1],c.startPage=""==d?1:parseInt(d),b&&(c.addition=parseInt(b));return c}
...
var IssuuImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var n=this,p,t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){n.index=b;n.type=d;n.i=l;n.callback=e;n.errorCallback=f;n.pageWidth=g;n.pageHeight=h;n.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(p=p.removeStartFrom("?"));n.imageURL=p;n.imageObject=new ImageObject;n.imageObject.alt(n.index);
...
c,d,e,f,g,h,k,l){var n=this,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){n.index=b;n.type=d;n.i=l;n.callback=e;n.errorCallback=f;n.pageWidth=g;n.pageHeight=h;n.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&!bookConfig.isEncryptionBook&&(p=p.removeStartFrom("?"));n.imageURL=p;n.$image=$("<img src='"+n.imageURL+"' style='z-index:0;'/>");bookConfig.EnableRecognizeQRcodePressOnMobile&&n.$image.css({"-webkit-touch-callout":"default"});n.$image[0].onload=function(){this.callback&&
this.callback(this.$image);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(n);n.$image[0].onerror=function(){this.errorCallback&&this.errorCallback(this.$image)}.bind(n);t.jumpToEnd()})},zoomIn:function(b){},zoomOut:function(b,c){},onResize:function(b,c){this.pageWidth=b;this.pageHeight=c;this.$image.css({width:"100%",height:"100%",position:"absolute",top:0,left:0});b=!1;if(isPhone()||isPad())b=!0;b=transformCSS({scale:1,
...
0;n=function(){l++;this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);p=function(w){l++;this.$images.removeElement(w);this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);for(t=0;t<k.length;t++)B=-1<k[t].indexOf(".svg")?new IssuuImageArrayLoadSvg(b,k[t],c,n,p,e,f,g,t):new IssuuImageArrayLoadImage(b,k[t],c,n,p,e,f,g,t),h.$images.push(B.$image),h.loadArray.push(B);v.jumpToEnd()})},zoomIn:function(b){for(var c=0;c<this.loadArray.length;c++)this.loadArray[c].zoomIn&&
...
c),pdfLoadStack.push(this.pdfLoadingTask))},destroy:function(){this.pdfLoadingTask&&(window.pdfLoadStack&&pdfLoadStack.pop(this.pdfLoadingTask),this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),IsuuPageBackground=Class({create:function(b,c,d,e,f,g,h){var k=this,l,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress){if(!b||!c)return t.return();k.type=c;k.pageWidth=e;k.pageHeight=f;return t.yield(getPageDir(b,c,originTotalPageCount),2)}l=t.yieldResult;n=getPageSize(b,
...
l/25)}.bind(this):function(){k=function(p,t){n(p,t,"Sine")}.animation(this,l)}.bind(this);var n=function(p,t,B){if(!b)return!1;var v=b.pageWidth,w=b.pageHeight,u=$.easing["easeInOut"+B],x=$.easing["easeOut"+B];B=x(null,p,g,b.toPoint.x-g,t);x=x(null,p,h,b.toPoint.y-h,t);b.dragMoveToFlip||(B=u(null,p,g,b.toPoint.x-g,t),x=bookConfig.FlipDirection?f*Math.sqrt(w*w-B*B):w-f*Math.sqrt(v*v-B*B));p<t?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
isDragMoveToFlip:function(b){b.dragMoveToFlip=!1;b.coordinate&&b.startPoint&&b.coordinate.x!=b.startPoint.x&&(b.dragMoveToFlip=!0)}}),IssuuSingleFlipBook=Class({pageBackArray:null,create:function(b){this.pageBackArray=[];this._super(b);this.flipPageManager=new IssuuFlipPageManager(this);this.toPageIndex=this.currentPageIndex;this.initBook();this.initEvent();this.flipIntervalManager=new IssuuFlipBookIntervalManager(this);this.pageInfoArray=(new PageInfo(!this.doublePage)).pageInfoArray},newFlipPage:function(){return new IssuuSingleFlipPage(this)},
resetPages:function(b){isNaN(b)||0>=b||(this.unWrapPageBackExcludeArray([b,b+1]),this.unWrapPageExcludeArray([b,b+1]),this.addPageArray([b,b+1]),this.addPageBackArray([b]),this.currentPage=this.pageArray[b],this.currentPage2=this.pageBackArray[b],this.nextPage=this.pageArray[b+1],this.previousPage=this.pageArray[b-1],this.previousPage2=this.pageBackArray[b-1],this.setPageCss(),this.loading())},setPageCss:function(){this.currentPage&&(this.setZIndexByPageIndex(this.currentPage),this.currentPage.clearTran());
this.previousPage&&(this.setZIndexByPageIndex(this.previousPage),this.previousPage.clearTran());this.previousPage2&&(this.setZIndexByPageIndex(this.previousPage2),this.previousPage2.clearTran());this.currentPage2&&(this.setZIndexByPageIndex(this.currentPage2),this.currentPage2.clearTran());this.nextPage&&(this.setZIndexByPageIndex(this.nextPage),this.nextPage.clearTran());rightToLeft?(this.currentPage&&this.currentPage.setLeftOrRight(!0),this.previousPage&&this.previousPage.setLeftOrRight(!0),this.previousPage2&&
this.previousPage2.setLeftOrRight(!0),this.currentPage2&&this.currentPage2.setLeftOrRight(!0),this.nextPage&&this.nextPage.setLeftOrRight(!0)):(this.currentPage&&this.currentPage.setLeftOrRight(!1),this.previousPage&&this.previousPage.setLeftOrRight(!1),this.previousPage2&&this.previousPage2.setLeftOrRight(!1),this.currentPage2&&this.currentPage2.setLeftOrRight(!1),this.nextPage&&this.nextPage.setLeftOrRight(!1))},addPageBackArray:function(b){if(b&&this.pageBackArray)for(var c=0;c<b.length;c++)if(!(0>=
b[c]||b[c]>originTotalPageCount||(!this.pageBackArray[b[c]]||this.flipping&&!imageLoaded[b[c]]||this.fillContent(b[c],!0),this.pageBackArray[b[c]]))){var d=this.newPageBack(b[c]),e=this.pageInfoArray[b[c]];d.mirrorSide();d.onResize(this.pageWidth*e.pageWidth,this.pageHeight*e.pageHeight,e.opacity);this.pageBackArray[b[c]]=d;this.flipping&&!imageLoaded[b[c]]||this.fillContent(b[c],!0);this.flipBook.append(d.$page)}},getDownUpPage:function(b,c){var d=b;b>c&&(d=c);this.addPageArray([d]);this.addPageBackArray([d]);
this.pageArray[d]&&this.pageArray[d].beginToFlip();this.pageBackArray[d]&&this.pageBackArray[d].beginToFlip();this.pageArray[d]&&this.pageArray[d].page.setCSSByName("right-flip-side");this.pageBackArray[d]&&(this.pageBackArray[d].page.setCSSByName("flip-side"),this.pageBackArray[d].page.side.addClass("boxShadow"));return[this.pageArray[d],this.pageBackArray[d]]},getDownUpHardPage:function(b,c){var d=b;b>c&&(d=c);this.addPageArray([d]);this.addPageBackArray([d]);rightToLeft?(this.pageArray[d]&&this.pageArray[d].setCSSByName("flip-hard-left-side"),
this.pageBackArray[d]&&this.pageBackArray[d].setCSSByName("flip-hard-right-side")):(this.pageArray[d]&&this.pageArray[d].setCSSByName("flip-hard-right-side"),this.pageBackArray[d]&&this.pageBackArray[d].setCSSByName("flip-hard-left-side"));return[this.pageArray[d],this.pageBackArray[d]]},flipToMax:function(b,c,d){var e=this.flipPageManager.initFlipPageByIndex(b,c);this.addPagesBeforeFlipToMax(c,d);this.pageArray[c]&&(this.pageArray[c].setLeftOrRight(rightToLeft),e.nextPage=this.pageArray[c]);this.setPagesStyleBeforeFlipToMax(c,
d);this.deleteUnnecessaryPagesBeforeFlipToMax(b,c);return e},hidePagesBeforeFlip:function(b){if(!this.supportSerialsFlip()){var c=this.pageArray.length;this.flipPageArray=[];var d=b.currentIndex;b=b.nextIndex;for(var e=[d,b],f=0;f<c;f++)0>e.indexOf(f)&&(this.pageArray[f]&&this.pageArray[f].visible&&(this.flipPageArray.push(this.pageArray[f]),this.pageArray[f].setVisible(!1)),this.pageBackArray[f]&&this.pageBackArray[f].visible&&(this.flipPageArray.push(this.pageBackArray[f]),this.pageBackArray[f].setVisible(!1)));
...
setPagesStyleBeforeFlipToMax:function(b,c){c&&(this.pageArray[b]&&(this.setZIndexByPageIndex(this.pageArray[b],b),this.pageArray[b].setLeftOrRight(rightToLeft)),this.pageBackArray[b]&&(this.setZIndexByPageIndex(this.pageBackArray[b],b),this.pageBackArray[b].setLeftOrRight(rightToLeft)),this.pageArray[b+1]&&(this.setZIndexByPageIndex(this.pageArray[b+1],b),this.pageArray[b+1].setLeftOrRight(rightToLeft)))},deleteUnnecessaryPagesBeforeFlipToMax:function(b,c){for(var d=c+1;d<=originTotalPageCount;d++)this.pageBackArray[d]&&
(this.pageBackArray[d]&&this.pageBackArray[d].remove(),this.pageBackArray[d]=void 0);for(d=c+2;d<=originTotalPageCount;d++)this.pageArray[d]&&(this.pageArray[d]&&this.pageArray[d].remove(),this.pageArray[d]=void 0);for(d=b+1;d<c;d++)if(this.pageArray[d]||this.pageBackArray[d])this.pageArray[d]&&this.pageArray[d].remove(),this.pageBackArray[d]&&this.pageBackArray[d].remove(),this.pageArray[d]=void 0,this.pageBackArray[d]=void 0},afterFlipToMax:function(b){this.addPagesAfterFlipToMax(b);this.setPagesStyleAfterFlipToMax(b);
this.deleteUnnecessaryPagesAfterFlipToMax(b)},addPagesAfterFlipToMax:function(b){this.supportSerialsFlip()||(this.addPageArray([b]),this.addPageBackArray([b]),this.addPageArray([b+1]));this.pageArray[b]&&this.fillContent(b);this.pageArray[b+1]&&this.fillContent(b+1)},setPagesStyleAfterFlipToMax:function(b){this.pageArray[b-1]&&this.setZIndexByPageIndex(this.pageArray[b-1],b);this.pageBackArray[b-1]&&this.setZIndexByPageIndex(this.pageBackArray[b-1],b);this.supportSerialsFlip()||(this.pageArray[b]&&
(this.setZIndexByPageIndex(this.pageArray[b]),this.pageArray[b].setLeftOrRight(rightToLeft)),this.pageBackArray[b]&&(this.setZIndexByPageIndex(this.pageBackArray[b]),this.pageBackArray[b].setLeftOrRight(rightToLeft)),this.pageArray[b+1]&&(this.setZIndexByPageIndex(this.pageArray[b+1]),this.pageArray[b+1].setLeftOrRight(rightToLeft)))},deleteUnnecessaryPagesAfterFlipToMax:function(b){for(b-=2;0<=b;b--)if(this.pageArray[b]||this.pageBackArray[b])this.pageArray[b]&&this.pageArray[b].remove(),this.pageBackArray[b]&&
this.pageBackArray[b].remove(),this.pageArray[b]=void 0,this.pageBackArray[b]=void 0},flipToMin:function(b,c,d){var e=this.flipPageManager.initFlipPageByIndex(b,c);this.addPagesBeforeFlipToMin(c,d);this.pageArray[b]&&(e.nextPage=this.pageArray[b]);this.setPagesStyleBeforeFlipToMin(c);this.deleteUnnecessaryPagesBeforeFlipToMin(b,c);return e},addPagesBeforeFlipToMin:function(b,c){},setPagesStyleBeforeFlipToMin:function(b){},deleteUnnecessaryPagesBeforeFlipToMin:function(b,c){for(--b;b>c;b--)if(this.pageArray[b]||
this.pageBackArray[b])this.pageArray[b]&&this.pageArray[b].remove(),this.pageBackArray[b]&&this.pageBackArray[b].remove(),this.pageArray[b]=void 0,this.pageBackArray[b]=void 0},afterFlipToMin:function(b){this.addPagesAfterFlipToMin(b);this.setPagesStyleAfterFlipToMin(b);this.deleteUnnecessaryPagesAfterFlipToMin(b)},addPagesAfterFlipToMin:function(b){this.supportSerialsFlip()||(this.addPageArray([b]),this.addPageBackArray([b]),this.addPageArray([b-1]));this.pageArray[b]&&this.fillContent(b);this.pageArray[b-
...
templateArea.getRightWidth(),e=bookConfig.topMargin+templateArea.getTopHeight(),f=bookConfig.bottomMargin+templateArea.getBottomHeight();b&&(c+=rightToLeft?bookConfig.hardCoverBorderWidth+totalThicknessWidth(!1):0,d+=rightToLeft?0:bookConfig.hardCoverBorderWidth+totalThicknessWidth(!1),e+=bookConfig.hardCoverBorderWidth,f+=bookConfig.hardCoverBorderWidth);return{left:c,right:d,top:e,bottom:f}},getTranX:function(b){if(!bookConfig.retainBookCenter)return 0;b=this.getCssLeft();var c=this.getSpace(!0);
return c.left+(windowWidth-c.left-c.right-this.width)/2-b},getTranY:function(){var b=this.getCssTop(),c=this.getSpace(!0);return c.top+(windowHeight-c.top-c.bottom-this.pageWidthHeight.y)/2-b}}).extend(FlipBook),IssuuDoubleFlipBook=Class({create:function(b){this._super(b);this.flipPageManager=new IssuuFlipPageManager(this);this.toPageIndex=this.currentPageIndex;this.initBook();this.initEvent();this.flipIntervalManager=new IssuuFlipBookIntervalManager(this);this.pageInfoArray=(new PageInfo(!this.doublePage)).pageInfoArray},
newFlipPage:function(){return new IssuuDoubleFlipPage(this)},resetPages:function(b){isNaN(b)||0>=b||(b=this.getMinPageIndex(b),this.unWrapPageExcludeArray([b,b+1,b+2,b+3,b-1,b-2]),this.addPageArray([b,b+1,b+2,b+3,b-1,b-2]),this.currentPage=this.pageArray[b],this.currentPage2=this.pageArray[b+1],this.nextPage=this.pageArray[b+2],this.nextPage2=this.pageArray[b+3],this.previousPage=this.pageArray[b-1],this.previousPage2=this.pageArray[b-2],this.setPageCss(),this.loading())},setPageCss:function(){this.currentPage&&
(this.setZIndexByPageIndex(this.currentPage),this.currentPage.clearTran());this.previousPage&&(this.setZIndexByPageIndex(this.previousPage),this.previousPage.clearTran());this.previousPage2&&(this.setZIndexByPageIndex(this.previousPage2),this.previousPage2.clearTran());this.currentPage2&&(this.setZIndexByPageIndex(this.currentPage2),this.currentPage2.clearTran());this.nextPage&&(this.setZIndexByPageIndex(this.nextPage),this.nextPage.clearTran());this.nextPage2&&(this.setZIndexByPageIndex(this.nextPage2),
this.nextPage2.clearTran());rightToLeft?(this.currentPage&&this.currentPage.setLeftOrRight(!1),this.previousPage&&this.previousPage.setLeftOrRight(!1),this.previousPage2&&this.previousPage2.setLeftOrRight(!1),this.currentPage2&&this.currentPage2.setLeftOrRight(!0),this.nextPage&&this.nextPage.setLeftOrRight(!0),this.nextPage2&&this.nextPage2.setLeftOrRight(!0)):(this.currentPage&&this.currentPage.setLeftOrRight(!0),this.previousPage&&this.previousPage.setLeftOrRight(!0),this.previousPage2&&this.previousPage2.setLeftOrRight(!0),
this.currentPage2&&this.currentPage2.setLeftOrRight(!1),this.nextPage&&this.nextPage.setLeftOrRight(!1),this.nextPage2&&this.nextPage2.setLeftOrRight(!1))},getDownUpHardPage:function(b,c,d){this.addPageArray([b,c]);d?(this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-left-side"),this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-right-side")):(this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-right-side"),this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-left-side"));
return[this.pageArray[b],this.pageArray[c]]},getDownUpPage:function(b,c){this.addPageArray([b,c]);this.pageArray[b]&&this.pageArray[b].beginToFlip();this.pageArray[c]&&this.pageArray[c].beginToFlip();this.pageArray[b]&&(this.pageArray[b].page.setCSSByName("right-flip-side"),this.setZIndexByPageIndex(this.pageArray[b]));this.pageArray[c]&&(this.pageArray[c].page.setCSSByName("flip-side"),this.pageArray[c].page.side.addClass("boxShadow"),this.setZIndexByPageIndex(this.pageArray[c]));return[this.pageArray[b],
this.pageArray[c]]},flipToMax:function(b,c,d,e){e=this.flipPageManager.initFlipPageByIndex(b,c,e);this.addPagesBeforeFlipToMax(c,d);this.pageArray[c+1]&&(this.pageArray[c+1].setLeftOrRight(rightToLeft),e.nextPage=this.pageArray[c+1]);this.setPagesStyleBeforeFlipToMax(c,d);this.deleteUnnecessaryPagesBeforeFlipToMax(b,c);return e},addPagesBeforeFlipToMax:function(b,c){this.addPageArray([b+1]);c&&this.supportSerialsFlip()&&this.addPageArray([b+2,b+3])},setPagesStyleBeforeFlipToMax:function(b,c){c&&this.supportSerialsFlip()&&
(this.pageArray[b+1]&&this.setZIndexByPageIndex(this.pageArray[b+1],b),this.pageArray[b+2]&&(this.setZIndexByPageIndex(this.pageArray[b+2],b),this.pageArray[b+2].setLeftOrRight(rightToLeft)),this.pageArray[b+3]&&(this.setZIndexByPageIndex(this.pageArray[b+3],b),this.pageArray[b+3].setLeftOrRight(rightToLeft)))},deleteUnnecessaryPagesBeforeFlipToMax:function(b,c){for(var d=c+4;d<=originTotalPageCount;d++)this.pageArray[d]&&(this.pageArray[d].remove(),this.pageArray[d]=void 0);for(d=b+1;d<c;d++)this.pageArray[d]&&
(this.pageArray[d].remove(),this.pageArray[d]=void 0)},afterFlipToMax:function(b,c){b=this.getMinPageIndex(b);this.addPagesAfterFlipToMax(b);this.setPagesStyleAfterFlipToMax(b);this.deleteUnnecessaryPagesAfterFlipToMax(b)},addPagesAfterFlipToMax:function(b){this.flipping||this.addPageArray([b+3,b,b-1,b-2]);this.supportSerialsFlip()||this.addPageArray([b+2,b+3]);this.pageArray[b+1]&&this.fillContent(b+1);this.pageArray[b+2]&&this.fillContent(b+2);this.pageArray[b+3]&&this.fillContent(b+3)},setPagesStyleAfterFlipToMax:function(b){this.pageArray[b]&&
(this.setZIndexByPageIndex(this.pageArray[b],b),this.pageArray[b].setLeftOrRight(!rightToLeft));this.pageArray[b-1]&&(this.setZIndexByPageIndex(this.pageArray[b-1],b),this.pageArray[b-1].setLeftOrRight(!rightToLeft));this.pageArray[b-2]&&(this.setZIndexByPageIndex(this.pageArray[b-2],b),this.pageArray[b-2].setLeftOrRight(!rightToLeft));this.supportSerialsFlip()&&this.flipping||(this.pageArray[b+1]&&this.setZIndexByPageIndex(this.pageArray[b+1]),this.pageArray[b+2]&&(this.setZIndexByPageIndex(this.pageArray[b+
2]),this.pageArray[b+2].setLeftOrRight(rightToLeft)),this.pageArray[b+3]&&(this.setZIndexByPageIndex(this.pageArray[b+3]),this.pageArray[b+3].setLeftOrRight(rightToLeft)))},deleteUnnecessaryPagesAfterFlipToMax:function(b){for(b-=3;0<=b;b--)this.pageArray[b]&&(this.pageArray[b].remove(),this.pageArray[b]=void 0)},flipToMin:function(b,c,d,e){e=this.flipPageManager.initFlipPageByIndex(b,c,e);this.addPagesBeforeFlipToMin(c,d);this.pageArray[c-1]&&(this.pageArray[c-1].setLeftOrRight(!rightToLeft),e.nextPage=
this.pageArray[c-1]);this.setPagesStyleBeforeFlipToMin(c,d);this.deleteUnnecessaryPagesBeforeFlipToMin(b,c);return e},addPagesBeforeFlipToMin:function(b,c){this.addPageArray([b-1]);c&&this.supportSerialsFlip()&&this.addPageArray([b-2,b-3])},setPagesStyleBeforeFlipToMin:function(b,c){c&&this.supportSerialsFlip()&&(this.pageArray[b-1]&&this.setZIndexByPageIndex(this.pageArray[b-1],b),this.pageArray[b-2]&&(this.setZIndexByPageIndex(this.pageArray[b-2],b),this.pageArray[b-2].setLeftOrRight(!rightToLeft)),
this.pageArray[b-3]&&(this.setZIndexByPageIndex(this.pageArray[b-3],b),this.pageArray[b-3].setLeftOrRight(!rightToLeft)))},deleteUnnecessaryPagesBeforeFlipToMin:function(b,c){for(var d=c-4;0<=d;d--)this.pageArray[d]&&(this.pageArray[d].remove(),this.pageArray[d]=void 0);for(d=b-1;d>c;d--)this.pageArray[d]&&(this.pageArray[d].remove(),this.pageArray[d]=void 0)},afterFlipToMin:function(b,c){b=this.getMaxPageIndex(b);this.addPagesAfterFlipToMin(b);this.setPagesStyleAfterFlipToMin(b);this.deleteUnnecessaryPagesAfterFlipToMin(b)},
addPagesAfterFlipToMin:function(b){this.flipping||this.addPageArray([b-3,b,b+1,b+2]);this.supportSerialsFlip()||this.addPageArray([b-2,b-3]);this.pageArray[b-1]&&this.fillContent(b-1);this.pageArray[b-2]&&this.fillContent(b-2);this.pageArray[b-3]&&this.fillContent(b-3)},setPagesStyleAfterFlipToMin:function(b){this.pageArray[b]&&(this.setZIndexByPageIndex(this.pageArray[b],b),this.pageArray[b].setLeftOrRight(rightToLeft));this.pageArray[b+1]&&(this.setZIndexByPageIndex(this.pageArray[b+1],b),this.pageArray[b+
1].setLeftOrRight(rightToLeft));this.pageArray[b+2]&&(this.setZIndexByPageIndex(this.pageArray[b+2],b),this.pageArray[b+2].setLeftOrRight(rightToLeft));this.supportSerialsFlip()&&this.flipping||(this.pageArray[b-1]&&this.setZIndexByPageIndex(this.pageArray[b-1]),this.pageArray[b-2]&&(this.setZIndexByPageIndex(this.pageArray[b-2]),this.pageArray[b-2].setLeftOrRight(!rightToLeft)),this.pageArray[b-3]&&(this.setZIndexByPageIndex(this.pageArray[b-3]),this.pageArray[b-3].setLeftOrRight(!rightToLeft)))},
deleteUnnecessaryPagesAfterFlipToMin:function(b){for(b+=3;b<=originTotalPageCount;b++)this.pageArray[b]&&(this.pageArray[b].remove(),this.pageArray[b]=void 0)},getFlipTo:function(b){var c=this.getMinPageIndex(this.currentPageIndex);b=this.getMinPageIndex(b);var d=c+1,e="";b>d&&(e="max");b+1<c&&(e="min",b+=1);return{flipTo:e,minIndex:c,maxIndex:d,toIndex:b}},getCurrentPages:function(){return BookInfo.getPagesByIndex(this.currentPageIndex)},getPagesByIndex:function(b){return BookInfo.getPagesByIndex(b)},
movetoCenter:function(b,c,d){if(!this.status_zoom&&bookConfig.retainBookCenter&&!(1<BookInfo.getPagesByIndex(b).length&&1<BookInfo.getPagesByIndex(c).length)){var e=this.pageWidth,f=-e/2,g=e/2,h=0,k=0;BookInfo.isLeftPage(b,!0)||1!=BookInfo.getPagesByIndex(b).length||(h=f);BookInfo.isLeftPage(b,!0)&&1==BookInfo.getPagesByIndex(b).length&&(h=g);BookInfo.isLeftPage(c,!0)||1!=BookInfo.getPagesByIndex(c).length||(k=f);BookInfo.isLeftPage(c,!0)&&1==BookInfo.getPagesByIndex(c).length&&(k=g);this.fromTrans=
0>this.movedX*k&&this.toTrans!=k?this.movedX:h;this.toTrans=k;b=2*e;void 0==d&&(d=b);isNaN(d)||(this.movedLength=d,this.movedX=$.easing.easeInOutSine(null,d,this.fromTrans,this.toTrans-this.fromTrans,b),d={tran:{x:parseInt(this.movedX),y:0}},this.setCSS(d))}},edgeX:function(){this.MiddleX=0},getFromStartPointByIndex:function(b,c){var d=this.getMinPageIndex(this.currentPageIndex),e=d+1;if(b!=e&&b!=d){var f={x:0,y:0},g={x:0,y:0},h=c.getPageWidthHeight().width;c=c.getPageWidthHeight().height;var k=!1;
if(b>e&&!rightToLeft||b<d&&rightToLeft)f={x:h,y:c},g.x=f.x-2,g.y=f.y-2,k=!0;if(b<d&&!rightToLeft||b>e&&rightToLeft)f={x:-h,y:c},g.x=f.x+2,g.y=f.y-2,k=!1;this.flipToDirection=k?"left":"right";return[f,g]}},afterZoomIn:function(b){if(!isPhone()&&!isPad()||bookConfig.usePdfJs){if(isPhone()||isPad()||this.showPages(),b&&this.flipBook.parameters&&!this.flipBook.parameters.resize){this.flipBook.parameters.resize=!0;b=this.flipBook.offset().left;var c=this.flipBook.offset().top,d=this.flipBook.parameters.left,
e=c-this.flipBook.parameters.top;var f=this.flipBook.parameters.scale;d={tran:{x:parseInt(b-d),y:parseInt(e)},scale:1,origin:{x:0,y:0}};1!=f&&this.resizeBook(Math.round(this.width*f),Math.round(this.height*f),f);this.status_zoom||(d.tran={x:0,y:0},d.left=b-0,d.top=c-0);this.setCSS(d);this.flipBook.parameters.tran=d.tran;this.flipBook.parameters.scale=1;this.flipBook.parameters.toScale=1;this.flipBook.parameters.width=$(this.flipBook).width();this.flipBook.parameters.height=$(this.flipBook).height();
...
1]?b.setZIndex(2):b==this.pageArray[c+2]?b.setZIndex(1):b==this.pageArray[c+3]?b.setZIndex(0):b==this.pageArray[c]?b.setZIndex(2):b==this.pageArray[c-1]?b.setZIndex(1):b==this.pageArray[c-2]&&b.setZIndex(0))},getFitWH:function(){var b=this.getCurrentPageIndex(),c=this.getFitWHByIndex(b);b=parseInt(c[0].x+c[1].x);c=parseInt(c[0].y);return{x:b,y:c}},getSpace:function(b){var c=bookConfig.leftMargin+templateArea.getLeftWidth(),d=bookConfig.rightMargin+templateArea.getRightWidth(),e=bookConfig.topMargin+
templateArea.getTopHeight(),f=bookConfig.bottomMargin+templateArea.getBottomHeight();b&&(c+=bookConfig.hardCoverBorderWidth+totalThicknessWidth(!0),d+=bookConfig.hardCoverBorderWidth+totalThicknessWidth(!0),e+=bookConfig.hardCoverBorderWidth,f+=bookConfig.hardCoverBorderWidth);return{left:c,right:d,top:e,bottom:f}},getMinPageIndex:function(b){return b=bookConfig.isTheBookOpen?2*Math.ceil(b/2)-1:2*Math.floor(b/2)},getMaxPageIndex:function(b){return b=bookConfig.isTheBookOpen?2*Math.ceil(b/2):2*Math.floor(b/
2)+1},getTranX:function(b){if(!bookConfig.retainBookCenter)return 0;b=this.getCssLeft();var c=this.getSpace(!0);return c.left+(windowWidth-c.left-c.right-this.width)/2-b},getTranY:function(){var b=this.getCssTop(),c=this.getSpace(!0);return c.top+(windowHeight-c.top-c.bottom-this.pageWidthHeight.y)/2-b}}).extend(FlipBook),IssuuBook=Class({bookType:BookType.normal_book,doublePage:!0,create:function(b){bookConfig.bookPageStretch=!0;this._super(b);this.resetZoomArea();bookConfig.supportSerialsFlip=!1},
initBook:function(){this._super()},resetBookShadow:function(b){},hasTwoSingleFlipPage:function(b){for(var c=this.flipPageManager.array.length,d,e=0;e<c;e++){var f=this.flipPageManager.array[e],g=this.flipPageManager[f].nextIndex;f=this.flipPageManager[f].currentIndex;1==BookInfo.getPagesByIndex(g).length&&(d=g);1==BookInfo.getPagesByIndex(f).length&&(d=f)}return d&&(d!=b&&1==BookInfo.getPagesByIndex(b).length||d!=this.currentPageIndex&&1==BookInfo.getPagesByIndex(this.currentPageIndex).length)?!0:
...
b;this.pageHeight=c;this.maskWidth=parseInt(Math.sqrt(b*b+c*c));0!=(this.maskWidth-this.height)%2&&(this.maskWidth+=1);this.setCSS({width:this.width,height:this.height});this.resizePage(this.pageWidth,this.pageHeight,d);this.resetBookShadow(this.currentPageIndex)},resizePage:function(b,c,d){b=this.getFitWHByIndex(this.currentPageIndex);var e=BookInfo.getLeftPages(this.currentPageIndex);c=BookInfo.getRightPages(this.currentPageIndex);for(var f=0;f<e.length;f++){var g=this.pageArray[e[f]];if(g)if(d)g.onResize(g.pageWidth*
d,g.pageHeight*d);else g.onResize(b[0].x,b[0].y)}for(e=0;e<c.length;e++)if(g=this.pageArray[c[e]])if(d)g.onResize(g.pageWidth*d,g.pageHeight*d);else g.onResize(b[1].x,b[1].y)},addPageArray:function(b){if(b&&this.pageArray)for(var c=0;c<b.length;c++)if(!(0>=b[c]||b[c]>originTotalPageCount||(this.pageArray[b[c]]&&this.fillContent(b[c]),this.pageArray[b[c]]))){var d=this.newPage(b[c]);d.fillPreviewImage();var e=this.getFitWHByIndex(this.currentPageIndex);if(b[c]>=this.getMaxPageIndex(this.currentPageIndex)&&
bookConfig.RightToLeft||b[c]<=this.getMinPageIndex(this.currentPageIndex)&&!bookConfig.RightToLeft)d.onResize(e[0].x,e[0].y);else d.onResize(e[1].x,e[1].y);this.pageArray[b[c]]=d;this.fillContent(b[c]);this.flipBook.append(d.$page)}},resizeAttachments:function(b,c){this.bookAttachments.onResize(b,c)},resetPages:function(b){this._super(b);b=this.getTranScaleByIndex(b);this.scalePages(BookInfo.getRightPages(this.currentPageIndex),2,2,b[1],b[1],{x:0,y:50});this.scalePages(BookInfo.getLeftPages(this.currentPageIndex),
2,2,b[0],b[0],{x:100,y:50})},afterFlipTo:function(b,c){this._super(b,c);resizeFlipBook();this.scalePages(BookInfo.getRightPages(this.currentPageIndex),2,2,{x:1,y:1},{x:1,y:1},{x:0,y:50});this.scalePages(BookInfo.getLeftPages(this.currentPageIndex),2,2,{x:1,y:1},{x:1,y:1},{x:100,y:50})},afterCurling:function(){this._super();this.getTranScaleByIndex(this.currentPageIndex);this.scalePages(BookInfo.getRightPages(this.currentPageIndex),2,2,{x:1,y:1},{x:1,y:1},{x:0,y:50});this.scalePages(BookInfo.getLeftPages(this.currentPageIndex),
2,2,{x:1,y:1},{x:1,y:1},{x:100,y:50})},movetoCenter:function(b,c,d){if(bookConfig.retainBookCenter){var e=this.getMovedXByIndex(c).x-this.getMovedXByIndex(b).x,f=this.width;if(void 0==d||d>f)d=f;if(!isNaN(d)){this.movedLength=d;var g=this.getFitWHByIndex(b),h=this.getFitWHByIndex(c);this.status_zoom&&(g=this.getFitWHByIndex(b,this.width,this.height),h=this.getFitWHByIndex(c,this.width,this.height));this.getFlipTo(c);var k=BookInfo.getMinPageIndex(b),l=BookInfo.getMaxPageIndex(b);if(bookConfig.RightToLeft)if(b<
c){var n=this.scalePages([k,k-1,k-2],d,f,g[1],h[1],{x:0,y:50});k=this.scalePages([l,c],d,f,g[0],h[1],{x:100,y:50},!1,0,{x:-g[1].x,y:0});var p=this.scalePages([c+1],d,f,g[0],h[0],{x:100,y:50},!0,k);this.scalePages([c+2],d,f,g[0],h[0],{x:100,y:50})}else k=this.scalePages([k,c],d,f,g[1],h[0],{x:100,y:50},!1,0,{x:-g[1].x,y:0}),n=this.scalePages([c-1],d,f,g[1],h[1],{x:0,y:50},!0,k),this.scalePages([c-2],d,f,g[1],h[1],{x:0,y:50}),p=this.scalePages([l,l+1,l+2],d,f,g[0],h[0],{x:100,y:50});else b<c?(p=this.scalePages([k,
k-1,k-2],d,f,g[0],h[0],{x:100,y:50}),k=this.scalePages([l,c],d,f,g[1],h[0],{x:100,y:50},!1,0,{x:-g[1].x,y:0}),n=this.scalePages([c+1],d,f,g[1],h[1],{x:0,y:50},!0,k),this.scalePages([c+2],d,f,g[1],h[1],{x:0,y:50})):(k=this.scalePages([k,c],d,f,g[0],h[1],{x:100,y:50},!1,0,{x:-g[1].x,y:0}),p=this.scalePages([c-1],d,f,g[0],h[0],{x:100,y:50},!0,k),this.scalePages([c-2],d,f,g[0],h[0],{x:100,y:50}),n=this.scalePages([l,l+1,l+2],d,f,g[1],h[1],{x:0,y:50}));this.movedX=$.easing.easeInOutSine(null,d,0,e+(h[0].x-
g[0].x)-0,f);e={tran:{x:parseInt(this.movedX),y:0}};this.status_zoom||this.setCSS(e);this.bookAttachments.Items.find("ThicknessManager").each(function(t){t.leftThickness&&t.leftThickness.doSetMovingScale(b,c,d,f,!1,p.y,(-p.x+1)*g[0].x);t.rightThickness&&t.rightThickness.doSetMovingScale(b,c,d,f,!1,n.y,(n.x-1)*g[1].x)}.bind(this));this.bookAttachments.Items.find("BookmarkTab").each(function(t){t.setScale(p.x,p.y,(-p.x+1)*g[0].x,(-p.y+1)*g[0].y/2,n.x,n.y,(n.x-1)*g[1].x,(-p.y+1)*g[1].y/2)}.bind(this))}}},
getDownUpPage:function(b,c){this.addPageArray([b,c]);var d=this.getFitWHByIndex(this.currentPageIndex);d=transformCSS({tran:{x:-d[1].x,y:0},origin:{x:100,y:50}});this.pageArray[b]&&(this.pageArray[b].beginToFlip(),this.pageArray[b].setCSSByStyle(d));this.pageArray[c]&&(this.pageArray[c].beginToFlip(),this.pageArray[c].setCSSByStyle(d));this.pageArray[b]&&(this.pageArray[b].page.setCSSByName("right-flip-side"),this.setZIndexByPageIndex(this.pageArray[b]));this.pageArray[c]&&(this.pageArray[c].page.setCSSByName("flip-side"),
this.pageArray[c].page.side.addClass("boxShadow"),this.setZIndexByPageIndex(this.pageArray[c]));return[this.pageArray[b],this.pageArray[c]]},getMovedXByIndex:function(b){var c=this.getSpace(),d=this.getFitWHByIndex(b);b=parseInt(d[0].x+d[1].x);d=parseInt(d[0].y);return{x:(windowWidth-c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){try{var n=1,p=1;n=$.easing.easeInOutSine(null,c,1,f.x/e.x-1,d);p=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,
d);for(c=0;c<b.length;c++){var t=this.pageArray[b[c]];if(t){var B=transformCSS({tran:l?l:{x:0,y:0},scale:{x:n,y:p},origin:g});this.isCoverPage(b[c])&&(t.tran=l?l:{x:0,y:0},t.scale={x:n,y:p},t.rotateY?(t.$page[0].style.removeProperty("transform-origin"),d=void 0,B=transformCSS({scale:{x:n,y:p},perspective:6E3,rotateY:null!=(d=t.rotateY)?d:0})):(d=void 0,B=transformCSS({origin:g,scale:{x:n,y:p},perspective:6E3,rotateY:null!=(d=t.rotateY)?d:0})));t.setCSSByStyle(B);if(t.page.pageFlipShadow){var v=h?
transformCSS({scale:{x:k.x/n,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});t.page.pageFlipShadow&&t.page.pageFlipShadow.setCSSByStyle(v)}}}return{x:n,y:p}}catch(w){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,c,d){this.getSpace(!1);var e=this.getSpace(!0);c||(c=windowWidth-e.left-e.right);d||(d=windowHeight-e.top-e.bottom);e=[];b=[BookInfo.getLeftPageIndex(b),BookInfo.getRightPageIndex(b)];for(var f=0;f<b.length;f++)b[f]?e.push(window.pageList&&
pageList[b[f]-1]?pageList[b[f]-1]:{width:bookConfig.largePageWidth,height:bookConfig.largePageHeight}):e.push({width:0,height:bookConfig.largePageHeight});f=e[0].height;b=e[0].width;e=e[1]?f*e[1].width/e[1].height:0;c=fitPageWidthHeight(c,d,b+e,f);d=[];d.push({x:Math.round(b/(b+e)*c.x),y:Math.round(c.y)});d.push({x:Math.round(e/(b+e)*c.x),y:Math.round(c.y)});return d},getPagesFitWHByIndex:function(b){this.getSpace(!1);var c=this.getSpace(!0),d=windowWidth-c.left-c.right,e=windowHeight-c.top-c.bottom,
f=[];c=BookInfo.getPagesByIndex(b);for(var g=0;g<c.length;g++)c[g]?f.push(window.pageList&&pageList[c[g]-1]?pageList[c[g]-1]:{width:bookConfig.largePageWidth,height:bookConfig.largePageHeight}):f.push({width:0,height:bookConfig.largePageHeight});var h=f[0].height;g=f[0].width;f=f[1]?h*f[1].width/f[1].height:0;d=fitPageWidthHeight(d,e,g+f,h);e=[];e.push({x:Math.round(g/(g+f)*d.x),y:Math.round(d.y)});e.push({x:Math.round(f/(g+f)*d.x),y:Math.round(d.y)});return c[0]==b?e[0]:e[1]},getSpace:function(b){var c=
bookConfig.leftMargin+templateArea.getLeftWidth(),d=bookConfig.rightMargin+templateArea.getRightWidth(),e=bookConfig.topMargin+templateArea.getTopHeight(),f=bookConfig.bottomMargin+templateArea.getBottomHeight();b&&(c+=bookConfig.hardCoverBorderWidth+totalThicknessWidth(!0),d+=bookConfig.hardCoverBorderWidth+totalThicknessWidth(!0),e+=bookConfig.hardCoverBorderWidth,f+=bookConfig.hardCoverBorderWidth);return{left:c,right:d,top:e,bottom:f}},afterZoomIn:function(b){b&&this.flipBook.parameters&&!this.flipBook.parameters.resize&&
(this._super(b),this.bookAttachments.afterZoomIn(this.width,this.height))},getCurrentPageWidthHeight:function(b){this.edgeX();var c=this.getFitWHByIndex(this.currentPageIndex);if(b<=this.MiddleX&&!rightToLeft||b>=this.MiddleX&&rightToLeft)return{pageWidth:c[0].x,pageHeight:c[0].y};if(b<=this.MiddleX&&rightToLeft||b>=this.MiddleX&&!rightToLeft)return{pageWidth:c[1].x,pageHeight:c[1].y}},realPoint:function(b){if((b=b.originalEvent&&b.originalEvent.changedTouches?b.originalEvent.changedTouches:b.changedTouches?
...
y:e},{x:b,y:h}]}e=e-c-g[0].x;h=this.getCurrentPageWidthHeight(e);k=h.pageHeight;f=f-d-(this.pageHeight-k)/2;if(!b[1])return[{x:e,y:f}];h=b[1].pageX;b=b[1].pageY;h=h-c-g[0].x;b=b-d-(this.pageHeight-k)/2;return[{x:e,y:f},{x:h,y:b}]}}}).extend(IssuuDoubleFlipBook),SingleIssuuBook=Class({bookType:BookType.single_book,doublePage:!1,create:function(b){bookConfig.bookPageStretch=!0;this._super(b);this.resetZoomArea();bookConfig.supportSerialsFlip=!1},initBook:function(){this._super()},resetBookShadow:function(b){},
hasTwoSingleFlipPage:function(b){for(var c=this.flipPageManager.array.length,d,e=0;e<c;e++){var f=this.flipPageManager.array[e],g=this.flipPageManager[f].nextIndex;f=this.flipPageManager[f].currentIndex;1==BookInfo.getPagesByIndex(g).length&&(d=g);1==BookInfo.getPagesByIndex(f).length&&(d=f)}return d&&(d!=b&&1==BookInfo.getPagesByIndex(b).length||d!=this.currentPageIndex&&1==BookInfo.getPagesByIndex(this.currentPageIndex).length)?!0:!1},newPage:function(b){return new IssuuNormalPage(b,"page",!0,this.bookType)},
newPageBack:function(b){return new IssuuNormalPage(b,"pageBack",!0,BookType.single_book,!0)},flippingTo:function(b){this.currentPageIndex=b;this.currentPageIndex=Math.max(1,this.currentPageIndex);this.currentPageIndex=Math.min(originTotalPageCount,this.currentPageIndex);this.resetZoomArea()},resetZoomArea:function(){this.flipBook.parameters.zoomArea={left:0,top:0,right:0,bottom:0}},afterCurling:function(){this._super();this.resetBookShadow(this.currentPageIndex)},setAttachmentBeforeFlipTo:function(b){this.pauseAnimation();
this.bookAttachments.setAttachmentBeforeFlipTo(b);this.resetBookShadow(b)},setAttachmentAfterFlipTo:function(b){this.stopMedia();this.resetSlider();this.resetBookShadow(b);this.flipping||this.enterPage();bookConfig.ThumbnailsButtonVisible&&global.thumbnail&&(thumbnail.clearHighLight(),thumbnail.setHighLight(this.currentPageIndex));window.resizeBookAfterFlip&&!this.flipping&&window.setTimeout(function(){onStageResize()},30)},resizeBook:function(b,c,d){this.endFlip();this.width=b;this.height=c;this.pageWidth=
b;this.pageHeight=c;this.maskWidth=parseInt(Math.sqrt(b*b+c*c));0!=(this.maskWidth-this.height)%2&&(this.maskWidth+=1);this.setCSS({width:this.width,height:this.height});this.resizePage(this.pageWidth,this.pageHeight,d);this.resetBookShadow(this.currentPageIndex)},resizePage:function(b,c,d){b=this.getFitWHByIndex(this.currentPageIndex);for(var e=0;e<this.pageArray.length;e++)if(c=this.pageArray[e])if(d)c.onResize(c.pageWidth*d,c.pageHeight*d);else c.onResize(b[0].x,b[0].y);for(e=0;e<this.pageBackArray.length;e++)if(c=
this.pageBackArray[e])if(d)c.onResize(c.pageWidth*d,c.pageHeight*d);else c.onResize(b[0].x,b[0].y)},addPageArray:function(b){if(b&&this.pageArray)for(var c=0;c<b.length;c++)if(!(0>=b[c]||b[c]>originTotalPageCount||(this.pageArray[b[c]]&&this.fillContent(b[c]),this.pageArray[b[c]]))){var d=this.newPage(b[c]);d.fillPreviewImage();var e=this.getFitWHByIndex(this.currentPageIndex);d.onResize(e[0].x,e[0].y);this.pageArray[b[c]]=d;this.fillContent(b[c]);this.flipBook.append(d.$page)}},resizeAttachments:function(b,
...
this.scalePages(BookInfo.getRightPages(),2,2,{x:1,y:1},{x:1,y:1},{x:0,y:50});this.scalePages(BookInfo.getLeftPages(),2,2,{x:1,y:1},{x:1,y:1},{x:100,y:50})},movetoCenter:function(b,c,d){if(bookConfig.retainBookCenter){var e=this.getMovedXByIndex(c).x-this.getMovedXByIndex(b).x,f=this.width;if(void 0==d||d>f)d=f;if(!isNaN(d)){this.movedLength=d;var g=this.getFitWHByIndex(b),h=this.getFitWHByIndex(c);this.status_zoom&&(g=this.getFitWHByIndex(b,this.width,this.height),h=this.getFitWHByIndex(c,this.width,
this.height));if(bookConfig.RightToLeft)if(b<c){var k=this.scalePages([c],d,f,g[0],h[0],{x:0,y:50},!1,0,{x:-g[0].x,y:0});this.scalePages([c+1,c-1],d,f,g[0],h[0],{x:0,y:50},!0,k);this.scalePages([c,c-1],d,f,g[0],h[0],{x:0,y:50})}else k=this.scalePages([c],d,f,g[0],h[0],{x:0,y:50},!1,0,{x:-g[0].x,y:0}),this.scalePages([c+1,c-1],d,f,g[0],h[0],{x:0,y:50},!0,k),this.scalePages([c,c+1],d,f,g[0],h[0],{x:0,y:50});else b<c?(k=this.scalePages([c],d,f,g[0],h[0],{x:0,y:50},!1,0,{x:-g[0].x,y:0}),this.scalePages([c+
1,c-1],d,f,g[0],h[0],{x:0,y:50},!0,k),this.scalePages([c,c-1],d,f,g[0],h[0],{x:0,y:50})):(k=this.scalePages([c],f-d,f,g[0],h[0],{x:0,y:50},!1,0,{x:-g[0].x,y:0}),this.scalePages([c+1,c-1],f-d,f,g[0],h[0],{x:0,y:50},!0,k),this.scalePages([c,c+1],f-d,f,g[0],h[0],{x:0,y:50}));this.movedX=$.easing.easeInOutSine(null,b<c?d:f-d,0,e-0,f);e={tran:{x:parseInt(this.movedX),y:0}};this.status_zoom||this.setCSS(e);this.bookAttachments.Items.find("ThicknessManager").each(function(l){l.leftThickness&&l.leftThickness.hide();
l.rightThickness&&l.rightThickness.doSetMovingScale(b,c,d,f,!1,k.y,(k.x-1)*g[0].x)}.bind(this));this.bookAttachments.Items.find("BookmarkTab").each(function(l){l.setScale(1,1,0,0,k.x,k.y,(k.x-1)*g[0].x,(-k.y+1)*g[0].y/2)}.bind(this));this.hardCover&&this.hardCover.doSetMovingScale(k)}}},getDownUpPage:function(b,c){var d=b;b>c&&(d=c);this.addPageArray([d]);this.addPageBackArray([d]);b=this.getFitWHByIndex(this.currentPageIndex);b=transformCSS({tran:{x:-b[1].x,y:0},origin:{x:100,y:50}});this.pageArray[d]&&
(this.pageArray[d].beginToFlip(),this.pageArray[d].setCSSByStyle(b));this.pageBackArray[d]&&(this.pageBackArray[d].beginToFlip(),this.pageBackArray[d].setCSSByStyle(b));this.pageArray[d]&&this.pageArray[d].page.setCSSByName("right-flip-side");this.pageBackArray[d]&&(this.pageBackArray[d].page.setCSSByName("flip-side"),this.pageBackArray[d].page.side.addClass("boxShadow"));return[this.pageArray[d],this.pageBackArray[d]]},getMovedXByIndex:function(b){var c=this.getSpace(),d=this.getFitWHByIndex(b);
b=parseInt(d[0].x+d[1].x);d=parseInt(d[0].y);return{x:(windowWidth-c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){var n=this;try{var p=1,t=1;p=$.easing.easeInOutSine(null,c,1,f.x/e.x-1,d);t=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);c=function(v){if(v){var w=transformCSS({tran:l?l:{x:0,y:0},scale:{x:p,y:t},origin:g});if(n.isCoverPage(v.pageIndex))if(v.tran=l?l:{x:0,y:0},v.scale={x:p,y:t},v.rotateY){v.$page[0].style.removeProperty("transform-origin");
var u;w=transformCSS({scale:{x:p,y:t},perspective:6E3,rotateY:null!=(u=v.rotateY)?u:0})}else{var x;w=transformCSS({origin:g,scale:{x:p,y:t},perspective:6E3,rotateY:null!=(x=v.rotateY)?x:0})}v.setCSSByStyle(w);w=h?transformCSS({scale:{x:k.x/p,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});v.page.pageFlipShadow&&v.page.pageFlipShadow.setCSSByStyle(w)}};for(d=0;d<b.length;d++){var B=this.pageBackArray[b[d]];c(this.pageArray[b[d]]);c(B)}return{x:p,y:t}}catch(v){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},
getFitWHByIndex:function(b,c,d){this.getSpace(!1);var e=this.getSpace(!0);c||(c=windowWidth-e.left-e.right);d||(d=windowHeight-e.top-e.bottom);e=[];b=[b];for(var f=0;f<b.length;f++)b[f]?e.push(window.pageList&&pageList[b[f]-1]?pageList[b[f]-1]:{width:bookConfig.largePageWidth,height:bookConfig.largePageHeight}):e.push({width:0,height:bookConfig.largePageHeight});f=e[0].height;b=e[0].width;e=e[1]?f*e[1].width/e[1].height:0;c=fitPageWidthHeight(c,d,b+e,f);d=[];d.push({x:Math.round(b/(b+e)*c.x),y:Math.round(c.y)});
d.push({x:Math.round(e/(b+e)*c.x),y:Math.round(c.y)});return d},getPagesFitWHByIndex:function(b){this.getSpace(!1);var c=this.getSpace(!0);b=window.pageList&&pageList[b-1]?pageList[b-1]:{width:bookConfig.largePageWidth,height:bookConfig.largePageHeight};c=fitPageWidthHeight(windowWidth-c.left-c.right,windowHeight-c.top-c.bottom,b.width,b.height);return{x:Math.round(c.x),y:Math.round(c.y)}},getSpace:function(b){var c=bookConfig.leftMargin+templateArea.getLeftWidth(),d=bookConfig.rightMargin+templateArea.getRightWidth(),
e=bookConfig.topMargin+templateArea.getTopHeight(),f=bookConfig.bottomMargin+templateArea.getBottomHeight();b&&(c+=rightToLeft?bookConfig.hardCoverBorderWidth+totalThicknessWidth(!1):0,d+=rightToLeft?0:bookConfig.hardCoverBorderWidth+totalThicknessWidth(!1),e+=bookConfig.hardCoverBorderWidth,f+=bookConfig.hardCoverBorderWidth);return{left:c,right:d,top:e,bottom:f}},afterZoomIn:function(b){b&&this.flipBook.parameters&&!this.flipBook.parameters.resize&&(this._super(b),this.bookAttachments.afterZoomIn(this.width,
this.height))},getCurrentPageWidthHeight:function(b){this.edgeX();b=this.getFitWHByIndex(this.currentPageIndex);return{pageWidth:b[0].x,pageHeight:b[0].y}},realPoint:function(b){if((b=b.originalEvent&&b.originalEvent.changedTouches?b.originalEvent.changedTouches:b.changedTouches?b.changedTouches:[b])&&!(3<=b.length)){var c=this.realBookPosition()[0],d=this.realBookPosition()[1],e=b[0].pageX,f=b[0].pageY;bookConfig.upsideOnMobile()&&(e=b[0].pageY,f=windowHeight-b[0].pageX);var g=this.getFitWHByIndex(this.currentPageIndex);
if(bookConfig.FlipDirection){f=f-d-g[0].y;var h=this.getCurrentPageWidthHeight(f),k=h.pageWidth;e=this.pageWidth-(e-c)-(this.pageWidth-k)/2;if(!b[1])return[{x:f,y:e}];h=b[1].pageX;b=b[1].pageY;h=this.pageWidth-(h-c)-(this.pageWidth-k)/2;b=b-d-g[0].y;return[{x:f,y:e},{x:b,y:h}]}e=e-c-g[0].x;h=this.getCurrentPageWidthHeight(e);k=h.pageHeight;f=f-d-(this.pageHeight-k)/2;if(!b[1])return[{x:e,y:f}];h=b[1].pageX;b=b[1].pageY;h=h-c-g[0].x;b=b-d-(this.pageHeight-k)/2;return[{x:e,y:f},{x:h,y:b}]}}}).extend(IssuuSingleFlipBook),
CardBook=Class({create:function(b){this._super(b);this.defineProperty();this.bookType=BookType.card_book;this.currentPageIndex=this.getRealBookIndex(b.currentPageIndex);this.mainPageIndex=this.getRealBookIndex(b.currentPageIndex);this.initBook();this.initAttachments();this.initEvent()},defineProperty:function(){this.showPage=this.flipBookElement=this.bookAttachments=null;this.scrollableWidth=this.contentWidth=0;this.pageSpacing=bookConfig.continuousPageArrangement?0:windowWidth;this.dragStartOffset=
this.currentOffset=this.totalOffset=this.startOffset=0;this.swipeSpeed=this.panSpeed=this.scrollSpeed=1;this.unitOffset=0;this.unitRotate=-45;this.k=0;this.isNextPage=!0;this.flipAnimation=null;this.flipping=!1;this.isUpdateOffset=!0;this.status_resize=this.isZooming=this.status_zoom=this.selected=!1;this.toPageIndex=this.dMouseWheelTime=0},getRealBookIndex:function(b){return b=Number.between(b,1,bookConfig.totalPageCount)},initBook:function(){this.flipBookElement=$("<div class='card-book' id='card-book'></div>");
this.parent.append(this.flipBookElement);this.layoutPages("init")},layoutPages:function(b){var c=bookConfig.topMargin+templateArea.getTopHeight(),d=bookConfig.bottomMargin+templateArea.getBottomHeight(),e=bookConfig.leftMargin+templateArea.getLeftWidth(),f=bookConfig.rightMargin+templateArea.getRightWidth();f=windowWidth-e-f;d=windowHeight-c-d;var g=bookConfig.largePageWidth*(-parseFloat(bookConfig.visibleAreaLeft)+parseFloat(bookConfig.visibleAreaRight))/100,h=bookConfig.largePageHeight*(parseFloat(bookConfig.visibleAreaBottom)-
parseFloat(bookConfig.visibleAreaTop))/100;if(bookConfig.continuousPageArrangement)this.width=f,this.height=d,this.bookLeft=e,this.bookTop=c;else{var k=fitPageWidthHeight(f,d,g,h);this.width=parseInt(k.x);this.height=parseInt(k.y);this.bookLeft=e+(f-this.width)/2;this.bookTop=c+(d-this.height)/2}this.flipBookElement.css({width:this.width+"px",height:this.height+"px",left:this.bookLeft+"px",top:this.bookTop+"px"});this.setPageSize(g,h);this.updateDataWhenResize();this.refreshPages(b)},refreshPages:function(b){if(bookConfig.RightToLeft){var c=
1-(this.currentOffset-this.startOffset-this.pageWidth)/this.unitOffset;var d=Math.max(1,Math.ceil(1-(this.currentOffset-this.startOffset+this.width)/this.unitOffset)-2);c=Math.min(bookConfig.totalPageCount,Math.floor(c)+2)}else d=this.currentOffset-this.startOffset,c=d+this.width,d=Math.max(1,Math.floor(d/this.unitOffset)+1-2),c=Math.min(bookConfig.totalPageCount,Math.ceil(c/this.unitOffset)+2);for(var e=d;e<=c;e++){if(bookConfig.RightToLeft){var f=this.startOffset+this.unitOffset*(1-e)-this.currentOffset;
var g=this.unitRotate*(1-e)-this.k*this.currentOffset}else f=this.startOffset+this.unitOffset*(e-1)-this.currentOffset,g=this.unitRotate*(e-1)-this.k*this.currentOffset;if(this.pageArray[e]){var h=this.pageArray[e];h.refreshTransform({x:f,y:0},{x:0,y:g});if(!["flipping","flipped"].includes(b))h.onResize(this.pageWidth,this.pageHeight)}else h=new CardBookPage(this,e),h.initialize(this.pageWidth,this.pageHeight,{x:f,y:0},{x:0,y:g},e),this.pageArray[e]=h}if("flipping"!==b)for(b=0;b<this.pageArray.length;b++)(b<
d||b>c)&&this.pageArray[b]&&(this.pageArray[b].remove(),this.pageArray[b]=void 0);if(b=this.pageArray[this.currentPageIndex])this.currentPage=b,this.showPage=b.pagesElement,$(".card-side").css({"z-index":3}),$("#card-side-"+this.currentPageIndex).css({"z-index":4})},initAttachments:function(){this.bookAttachments=new BookAttachmentsBuilder(this.flipBookElement,this.currentPageIndex,this,this.options.isDoublePage);this.options.thickness&&this.bookAttachments.thickness(!0);this.options.bookshadow&&
this.bookAttachments.bookshadow();this.options.grayshadow&&this.bookAttachments.grayshadow();this.options.miniFullscreen&&this.bookAttachments.miniFullscreen();this.options.bookpagenumber&&this.bookAttachments.bookpagenumber();this.options.staticad&&this.bookAttachments.staticad();this.options.zoommap&&this.bookAttachments.zoommap();this.options.bookmarktab&&this.bookAttachments.bookmarktab();this.options.noteadd&&this.bookAttachments.noteadd()},getBook:function(){return this.flipBookElement},show:function(){this.visible=
!0;this.setStyleByCSS({display:"block"});this.enterPage();this.bookAttachments&&this.bookAttachments.show()},hide:function(){this.visible=!1;this.setStyleByCSS({display:"none"});this.stopMedia();this.resetSlider();this.bookAttachments&&this.bookAttachments.hide()},setStyleByCSS:function(b){this.flipBookElement.css(b)},enterPage:function(){this.afterChangeBookType();this.openShownMedia();this.addSearchHighlight()},afterChangeBookType:function(){for(var b=0;b<this.pageArray.length;b++)this.pageArray[b]&&
this.pageArray[b].initReaderOrSlider()},openShownMedia:function(){var b=this.pageArray[this.currentPageIndex];b&&(b.enterSide(),b.addHistoryTexts())},stopMedia:function(){for(var b=0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].leaveSide()},addSearchHighlight:function(){var b=this.pageArray[this.currentPageIndex];b&&b.highlightSearch()},clearSearchHighlight:function(){for(var b=0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].clearHighlight()},resetSlider:function(){for(var b=
0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].resetSlider()},onResize:function(){this.status_zoom=!1;this.endFlip();this.resizeBookAttachments();this.layoutPages("resize")},setPageSize:function(b,c){bookConfig.isSingleBookFullWindowOnMobile&&(isPhone()||isPad())?(this.pageWidth=windowWidth,this.pageHeight=windowHeight):(b=fitPageWidthHeight(this.width,this.height,b,c),isPhone()||isPad(),this.pageWidth=parseInt(b.x),this.pageHeight=parseInt(b.y))},resizeBookAttachments:function(){this.bookAttachments.onResize(this.width,
this.height)},getLeft:function(){return this.bookLeft},getTop:function(){return this.bookTop},getCssLeft:function(){return parseInt(this.flipBookElement.css("left"))},getCssTop:function(){return parseInt(this.flipBookElement.css("top"))},getHeight:function(){return this.height},getWidth:function(){return this.width},getScale:function(){var b=this.pageArray[this.currentPageIndex];return b?b.pagesElement.parameters.toScale:1},updateDataWhenResize:function(){var b=bookConfig.totalPageCount;this.contentWidth=
this.pageWidth*b+this.pageSpacing*(b-1);bookConfig.startingFromTheSide?(this.startOffset=0,this.scrollableWidth=this.contentWidth-this.width):(this.startOffset=this.width/2-this.pageWidth/2,this.scrollableWidth=this.contentWidth-this.pageWidth);this.unitOffset=this.pageWidth+this.pageSpacing;this.k=this.unitRotate/this.unitOffset},updateCurPageIndex:function(b){this.currentPageIndex=b},getCurrentPageIndex:function(){return this.getRealPageIndex()},getRealPageIndex:function(){var b=this.currentPageIndex;
return b=Number.between(b,1,bookConfig.totalPageCount)},getCurrentPages:function(){return[this.currentPageIndex]},gotoPage:function(b,c){this.toPageIndex=b;if(this.status_zoom){b={pointers:[{pageX:windowWidth/2,pageY:windowHeight/2}]};c=this.pageArray[this.currentPageIndex];if(!c)return;c=c.pagesElement;c.onDoubleTap.bind(c)(b);return!0}this.flipping||(!c&&flipHistory&&flipHistory.addFromCurrentIndex(this.toPageIndex),bookConfig.restorePageVisible&&this.toPageIndex!==this.currentPageIndex&&window.localStorage.setItem(realLocation+
"?historyPageIndex",this.toPageIndex),this.flipAnimation&&this.flipAnimation.stop(),this.bookAttachments.setAttachmentBeforeFlipTo(b),this.updateCurPageIndex(b),this.playFlipAnimation(b),playFlipSound())},playFlipAnimation:function(b){this.flipping=!0;this.isUpdateOffset&&this.updateTotalOffset(b);var c=this.currentOffset,d=this.totalOffset-c;this.flipAnimation=function(e,f){e<f?(this.currentOffset=(0,$.easing.easeInOutSine)(null,e,c,d,f),this.refreshPages("flipping")):(this.currentOffset=this.totalOffset,
this.refreshPages("flipped"),this.endFlip(),this.isUpdateOffset=!0,this.flipAnimation.stop(),this.afterPlayFlipAnimation(),BookEvent.trigger("afterFlipPage",[b]))}.bind(this).animation(this,this.flippingTime)},endFlip:function(){this.flipping=!1},updateTotalOffset:function(b){this.totalOffset=bookConfig.RightToLeft?-this.unitOffset*(b-1):this.unitOffset*(b-1)},afterPlayFlipAnimation:function(){this.loading();this.fillContent();this.stopMedia();this.resetSlider();this.enterPage();bookConfig.ThumbnailsButtonVisible&&
thumbnail&&(thumbnail.clearHighLight(),thumbnail.setHighLight(this.getRealPageIndex()));window.resizeBookAfterFlip&&window.setTimeout(function(){return onStageResize()},30);this.bookAttachments.setAttachmentAfterFlipTo()},select:function(){var b=this.pageArray[this.currentPageIndex];b&&(this.selected=!0,b.initSelectTextEvent(),b.pagesElement.parameters.eventCancel=!0)},unSelect:function(){var b=this.pageArray[this.currentPageIndex];b&&(this.selected=!1,b.destroySelect(),b.pagesElement.parameters.eventCancel=
!1,StateSynchronous.instance().findButtons("SelectTextButton",!0).each(function(c){c.setAsUnSelect();c.executeCallback()}))},magnifierZoom:function(){var b=this.pageArray[this.currentPageIndex];b&&(this.selected=!0,b.initMagnifierEvent())},unMagnifierZoom:function(){var b=this.pageArray[this.currentPageIndex];b&&(this.selected=!1,b.destroyMagnifier(),bookConfig.MagnifierButtonVisible&&window.magnifierZoomBox&&window.magnifierZoomBox.hide(),StateSynchronous.instance().findButtons("magnifier",!0).each(function(c){c.setAsZoomin()}))},
switchLargeImage:function(){var b=this.pageArray[this.currentPageIndex];b&&b.switchLargeImage()},switchNormalImage:function(b){var c=this.pageArray[this.currentPageIndex];c&&c.switchNormalImage(b)},hideOtherPage:function(){for(var b=0;b<this.pageArray.length;b++)b!==this.currentPageIndex&&this.pageArray[b]&&this.pageArray[b].setStyleByCSS({display:"none"})},showAllPage:function(){for(var b=0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].setStyleByCSS({display:"block"})},loading:function(){for(var b=
0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].loading()},fillContent:function(){for(var b=0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].fillContent()},destroy:function(){this.flipBookElement.remove()}}).extend(Book);
CardBook.expand({initEvent:function(){this.moveDirectionType={MOVE_LEFT:-1,MOVE_RIGHT:1,MOVE_NONE:0};this.mouseMoveDirection=this.moveDirectionType.MOVE_NONE;this.initHammerEvent();this.initDomEvent()},initHammerEvent:function(){var b=new Hammer.Manager(this.flipBookElement[0]);b.add(new Hammer.Pan);b.on("panstart panmove",this.onPan.bind(this));b.on("panend",this.onPanEnd.bind(this))},initDomEvent:function(){this.flipBookElement.bind("click",this.onTap.bind(this));bookConfig.mouseWheelFlip&&this.flipBookElement.bind(_event._mousewheel,
this.onScroll.bind(this))},onScroll:function(b){if(!(0>=this.scrollableWidth)){if(!this.canAcceptMouseWheel())return!1;var c=b.originalEvent;c=Math.max(-1,Math.min(1,c.wheelDelta||-c.detail));var d=this.pageArray[this.currentPageIndex];this.status_zoom&&(b={pointers:[{pageX:b.pageX,pageY:b.pageY},{pageX:b.pageX,pageY:b.pageY}]},d&&d.controlBar&&(0>c?d.controlBar.zoomDown(b):d.controlBar.zoomUp(b)));this.status_zoom||!bookConfig.mouseWheelFlip||this.flipping||(bookConfig.automaticAdsorption?(d=Math.ceil(this.scrollSpeed),
c=bookConfig.RightToLeft?0<c?this.currentPageIndex+d:this.currentPageIndex-d:0>c?this.currentPageIndex+d:this.currentPageIndex-d,this.isUpdateOffset=!0,gotoPageFun(c,!1,"mouse wheel flip")):(d=this.unitOffset*this.scrollSpeed/5,bookConfig.RightToLeft?(this.isNextPage=0<c?!0:!1,c=this.currentOffset+c*d,d=0<c?0:c<-this.scrollableWidth?bookConfig.totalPageCount+1:this.getTargetPageIndex(c)):(this.isNextPage=0>c?!0:!1,c=this.currentOffset+-c*d,d=0>c?0:c>this.scrollableWidth?bookConfig.totalPageCount+
1:this.getTargetPageIndex(c)),this.totalOffset=bookConfig.RightToLeft?Number.between(c,-this.scrollableWidth,0):Number.between(c,0,this.scrollableWidth),this.isUpdateOffset=!1,gotoPageFun(d,!1,"mouse wheel flip")));if(bookConfig.mouseWheelFlip)return stopEvent(b),!1}},canAcceptMouseWheel:function(){if(0!==this.dMouseWheelTime&&150>(new Date).getTime()-this.dMouseWheelTime)return!1;this.dMouseWheelTime=(new Date).getTime();return!0},onPan:function(b){bookType!=this.bookType||0>=this.scrollableWidth||
this.selected||this.isZoomming||this.status_zoom||this.status_resize||this.flipping||("panstart"==b.type?this.dragStartOffset=this.currentOffset:"panmove"!=b.type||bookConfig.FlipDirection||bookConfig.upsideOnMobile()||(bookConfig.RightToLeft?(b=this.dragStartOffset+-b.deltaX*this.panSpeed,this.isNextPage=b<this.dragStartOffset?!0:!1):(b=this.dragStartOffset+-b.deltaX*this.panSpeed,this.isNextPage=b>this.dragStartOffset?!0:!1),this.currentOffset=b,this.refreshPages("flipping")))},onPanEnd:function(b){this.status_zoom||
this.selected||(b=this.currentOffset-this.dragStartOffset,bookConfig.automaticAdsorption?(Math.abs(b)>=.05*this.unitOffset?(b=bookConfig.RightToLeft?-b/this.unitOffset:b/this.unitOffset,b=0<b?Math.ceil(b):Math.floor(b),b=this.currentPageIndex+b):b=this.currentPageIndex,b=Number.between(b,1,bookConfig.totalPageCount),this.isUpdateOffset=!0):(b=this.getTargetPageIndex(this.totalOffset),b=Number.between(b,1,bookConfig.totalPageCount),this.totalOffset=bookConfig.RightToLeft?Number.between(this.currentOffset,
-this.scrollableWidth,0):Number.between(this.currentOffset,0,this.scrollableWidth),this.isUpdateOffset=!1),gotoPageFun(b,!1,"pan to flip"))},getTargetPageIndex:function(b){b=bookConfig.RightToLeft?-b/this.unitOffset+1:b/this.unitOffset+1;return b=this.isNextPage?Math.ceil(b):Math.floor(b)},onTap:function(b){onWindowTap(b.srcEvent)}});
...
this.pagesElement=this.sideElement=this.parentElement=this.controlBar=this.parent=null;this.pageIndex=this.zIndex=this.pageHeight=this.pageWidth=0;this.bookType="";this.clickStartPosition=this.page=null},createPage:function(b){b=new Page(b,"page-",this.bookType);b.hideMiddleShadow();b.centerPage();this.page=b;return b.side},initEvent:function(){this.parent.adContainer&&this.parent.adContainer.css({"z-index":3});this.sideElement.bind("mousedown",function(b){this.clickStartPosition={x:b.pageX,y:b.pageY}}.bind(this));
this.sideElement.bind("click",this.onClick.bind(this));isBelowIE9()?this.pagesElement.IEZoom({sideElement:this,zoomIn:this.zoomIn.bind(this),zoomOut:this.zoomOut.bind(this),onZoomed:this.onZoomed.bind(this)}):this.pagesElement.zoom({sideElement:this,zoomIn:this.zoomIn.bind(this),zoomOut:this.zoomOut.bind(this),onZoomed:this.onZoomed.bind(this)})},initialize:function(b,c,d,e,f){this.onResize(b,c);this.refreshTransform(d,e)},enterSide:function(){this.page.enterSide()},leaveSide:function(){this.page.leaveSide()},
onResize:function(b,c){this.pageWidth=b;this.pageHeight=c;this.resizeSide(b,c);this.resizePages(b,c);this.resetPagesParameters();this.resizePage(b,c);this.resetPages()},resetPages:function(){var b=transformCSS({rotate:0,tran:{x:0,y:0},scale:1});this.pagesElement.css(b);this.parent.showAllPage()},resizeSide:function(b,c){this.sideElement.css({top:this.parent.height/2-c/2+"px",width:b+"px",height:c+"px"})},resizePages:function(b,c){this.pagesElement.css({width:b+"px",height:c+"px"})},resetPagesParameters:function(){this.pagesElement.parameters&&
(this.pagesElement.parameters.width=$(this.pagesElement).width(),this.pagesElement.parameters.height=$(this.pagesElement).height(),this.pagesElement.parameters.origin={x:0,y:0},this.pagesElement.parameters.tran={x:0,y:0},this.pagesElement.parameters.scale=1,this.pagesElement.parameters.toScale=1,this.pagesElement.parameters.resize=!1,this.pagesElement.swipeInterval&&this.pagesElement.swipeInterval.stop(),this.pagesElement.animateInterval&&this.pagesElement.animateInterval.stop(),this.pagesElement.parameters.zoomFlag=
!1,this.pagesElement.parameters.zoomOut=!0,this.pagesElement.parameters.toScale=1,this.pagesElement.parameters.scale=1)},resizePage:function(b,c){this.page.onResize(b,c)},refreshTransform:function(b,c){b=transformCSS({tran:b,rotateY:c.y});this.setStyleByCSS(b)},setStyleByCSS:function(b){this.sideElement.css(b)},fillContent:function(b){this.page.fillContent(b)},fillPage:function(b,c){this.page.fillPage(b,c)},onClick:function(b){this.clickStartPosition&&2<Math.sqrt(Math.pow(b.pageX-this.clickStartPosition.x,
2)+Math.pow(b.pageY-this.clickStartPosition.y,2))||this.parent.currentPageIndex!=this.pageIndex&&gotoPageFun(this.pageIndex,!1,"click card page")},zoomIn:function(b){this.parent.status_zoom=!0;this.parent.adContainer&&this.parent.adContainer.css({"z-index":1});StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(d){d.setAsZoomout();d.executeCallback()});global.toolBar&&global.toolBar.btnZoom&&global.toolBar.changeZoomIcon(!1);this.switchLargeImage();this.parent.hideOtherPage();bookConfig.ZoomToolbarVisible&&
!this.controlBar&&(this.controlBar=new ZoomControlBar(tmpContainer),this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+c+5));if(this.controlBar){var c="lite"==bookConfig.ToolbarViewMode&&bookType==BookType.catalog_book?50:0;this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+c+5);this.controlBar.setVisible(!0)}global.canMagnifierZoom&&BookInfo.getBook().unMagnifierZoom()},zoomOut:function(){this.parent.status_zoom=
!1;this.parent.flipping||!this.parent.adContainer||1!=this.parent.currentPageIndex||bookConfig.isTheBookOpen||this.parent.adContainer.css({"z-index":3});gotoPageFun(this.parent.toPageIndex,!1,"change book type");StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(b){b.setAsZoomin();b.executeCallback()});global.toolBar&&global.toolBar.btnZoom&&global.toolBar.changeZoomIcon(!0);this.switchNormalImage();this.parent.showAllPage();this.controlBar&&this.controlBar.setVisible(!1)},onZoomed:function(b){if(isPhone()||
isPad())this.onMobileZoomed(b);else this.onPCZoomed(b)},onPCZoomed:function(b){if(b&&!this.pagesElement.parameters.resize){this.pagesElement.parameters.resize=!0;b=this.pagesElement.offset().left;var c=this.pagesElement.offset().top;b-=this.pagesElement.parameters.left;c-=this.pagesElement.parameters.top;var d=this.pagesElement.parameters.scale;1!=d&&(this.pageWidth=parseInt(this.pageWidth*d),this.pageHeight=parseInt(this.pageHeight*d),this.resizePages(this.pageWidth,this.pageHeight),this.resizePage(this.pageWidth,
this.pageHeight),d=1);d=transformCSS({origin:{x:0,y:0},tran:{x:b,y:c},scale:d});this.pagesElement.css(d);this.pagesElement.parameters&&(this.pagesElement.parameters.width=$(this.pagesElement).width(),this.pagesElement.parameters.height=$(this.pagesElement).height(),this.pagesElement.parameters.origin={x:0,y:0},this.pagesElement.parameters.tran={x:b,y:c},this.pagesElement.parameters.scale=1,this.pagesElement.parameters.toScale=1,this.pagesElement.parameters.resize=!1)}},onMobileZoomed:function(b){this.resizeSvg(Math.round(this.pageWidth*
b.scale),Math.round(this.pageHeight*b.scale));bookConfig.highDefinitionConversion?this.zoomInSideImage():(1<b.scale&&this.zoomInSideImage(),1==b.scale&&this.zoomOutSideImage())},initSelectTextEvent:function(){this.page.initSelectTextEvent()},destroySelect:function(){this.page.destroySelect()},initMagnifierEvent:function(){this.page.initMagnifierEvent()},destroyMagnifier:function(){this.page.destroyMagnifier()},startAnimation:function(){this.page.startAnimation()},pauseAnimation:function(){this.page.pauseAnimation()},
addHistoryTexts:function(b){this.page.addHistoryTexts(b)},highlightSearch:function(){this.page.highlightSearch()},clearHighlight:function(){this.page.clearHighlight()},initReaderOrSlider:function(){this.page.initReaderOrSlider&&this.page.initReaderOrSlider()},resetSlider:function(){this.page.resetSlider&&this.page.resetSlider()},zoomInSideImage:function(){this.page.zoomInSideImage()},zoomOutSideImage:function(){this.page.zoomOutSideImage()},switchLargeImage:function(){this.page.switchLargeImage()},
switchNormalImage:function(b){this.page.switchNormalImage(b)},resizeSvg:function(b,c){this.page.resizeSvg(b,c)},loading:function(){this.page.loading()},destroy:function(){this.sideElement.remove()},remove:function(){this.controlBar&&this.controlBar.destroy();this.sideElement.remove();this.sideElement=void 0}}),BookEvent=Class({statics:{bindEvent:function(b,c){"string"==typeof b&&c&&"function"==typeof c&&(this[b]||(this[b]=[]),this[b].push(c))},bindOnceEvent:function(b,c){if("string"===typeof b&&c&&
"function"===typeof c){var d=function(e){for(var f=[],g=0;g<arguments.length;++g)f[g-0]=arguments[g];f=c.apply(this,f);this.removeEvent(b,d);return f}.bind(this);this[b]||(this[b]=[]);this[b].push(d)}},removeEvent:function(b,c){"string"==typeof b&&c&&"function"==typeof c&&this[b].removeElement(c)},trigger:function(b,c){if((b=this[b])&&0!=b.length){for(var d=!1,e=0;e<b.length;e++)if("function"==typeof b[e]){var f=b[e].apply(this,c);d=(f?f.paused:!1)||d}return d}}}});
